#!/usr/bin/env python3
"""Train and evaluate the in-app operation neural quantile experiment group."""
...
def evaluate(model: OpQuantileModel, test_samples: list[dict], top_k: list[int]) -> list[dict]:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train in-app operation neural quantile experiment group.")
    ...
    parser.add_argument("--quantiles", nargs="+", type=float, default=[0.5, 0.9])
    parser.add_argument("--rank-quantile", type=float, default=0.9)
    parser.add_argument("--hidden-size", type=int, default=64)
    parser.add_argument("--epochs", type=int, default=5)
    parser.add_argument("--learning-rate", type=float, default=0.05)
    parser.add_argument("--top-k", nargs="+", type=int, default=[1, 3, 5])
    parser.add_argument("--output", default="outputs/results/op_quantile_results.csv")
...
def main() -> None:
    ...
    print(f"rank quantile: {model.rank_quantile}")
