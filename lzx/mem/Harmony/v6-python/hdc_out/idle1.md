...
| 采样时间 | `2026-05-31 19:56:48` |
| VMA 数 | `6515` |
| Size | `48586976 KiB` |
| Rss | `622792 KiB` |
| Pss | `457856 KiB` |
| Referenced | `72948 KiB / 18237 页` |
| Swap | `56988 KiB` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| ark ts heap | 324 | 98816 | 92804 | 86952 | 20592 | 88 | 20.84% | 22.19% |
| native heap | 164 | 393656 | 244832 | 235440 | 33656 | 32916 | 8.55% | 13.75% |
| AnonPage other | 11 | 1590028 | 11172 | 11172 | 536 | 8 | 0.03% | 4.80% |
| FilePage other | 1368 | 706204 | 39272 | 31005 | 3968 | 3968 | 0.56% | 10.10% |
| stack | 2 | 8184 | 100 | 100 | 32 | 0 | 0.39% | 32.00% |
| .so | 3749 | 709736 | 188592 | 65681 | 12960 | 14840 | 1.83% | 6.87% |
| .hap | 23 | 178448 | 8348 | 8229 | 260 | 0 | 0.15% | 3.11% |
| .ttf | 6 | 67444 | 10976 | 1838 | 0 | 0 | 0.00% | 0.00% |
| dev | 230 | 41100 | 14140 | 13466 | 100 | 0 | 0.24% | 0.71% |
| GL | 177 | 71716 | 10764 | 3771 | 616 | 5012 | 0.86% | 5.72% |
| Graph | 44 | 5864 | 1772 | 190 | 228 | 132 | 3.89% | 12.87% |
| guard | 417 | 44715780 | 20 | 12 | 0 | 24 | 0.00% | 0.00% |

## Referenced VMA 定位

| VMA | 一级段 | 权限 | Size(KiB) | Rss(KiB) | Pss(KiB) | Referenced(KiB) | Referenced页 | Referenced/Size | 路径 |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `005d24388000-005d24b88000` | native heap | `rw-p` | 8192 | 7724 | 7724 | 7248 | 1812 | 88.48% | `[anon:native_heap:jemalloc]` |
| `005d25585000-005d25f85000` | native heap | `rw-p` | 10240 | 6308 | 6308 | 3164 | 791 | 30.90% | `[anon:native_heap:jemalloc]` |
| `005d1c67f000-005d1e27f000` | native heap | `rw-p` | 28672 | 26940 | 26940 | 3076 | 769 | 10.73% | `[anon:native_heap:jemalloc]` |
| `005afa5d2000-005afb5d2000` | native heap | `rw-p` | 16384 | 13016 | 13016 | 2796 | 699 | 17.07% | `[anon:native_heap:jemalloc]` |
| `005c542f9000-005c54ff9000` | native heap | `rw-p` | 13312 | 9008 | 9008 | 2796 | 699 | 21.00% | `[anon:native_heap:jemalloc]` |
| `005ae8849000-005aeb449000` | native heap | `rw-p` | 45056 | 16084 | 12553 | 2616 | 654 | 5.81% | `[anon:native_heap:jemalloc]` |
| `005ad3111000-005ad38ba000` | .so | `r-xp` | 7844 | 5052 | 228 | 2612 | 653 | 33.30% | `/system/lib64/platformsdk/libark_jsruntime.so` |
| `005c50052000-005c51452000` | native heap | `rw-p` | 20480 | 19720 | 19720 | 1940 | 485 | 9.47% | `[anon:native_heap:jemalloc]` |
| `005d2208a000-005d2408a000` | native heap | `rw-p` | 32768 | 26832 | 26832 | 1772 | 443 | 5.41% | `[anon:native_heap:jemalloc]` |
| `005d17436000-005d18c36000` | native heap | `rw-p` | 24576 | 23832 | 23832 | 1652 | 413 | 6.72% | `[anon:native_heap:jemalloc]` |
| `005d29e6a000-005d2ce6a000` | native heap | `rw-p` | 49152 | 34316 | 34316 | 1340 | 335 | 2.73% | `[anon:native_heap:jemalloc]` |
| `005ae8180000-005ae83d8000` | .so | `r-xp` | 2400 | 1688 | 617 | 1324 | 331 | 55.17% | `/vendor/lib64/passthrough/libhvgr_v210.so` |
| `005d26d8e000-005d2958e000` | native heap | `rw-p` | 40960 | 39524 | 39524 | 1324 | 331 | 3.23% | `[anon:native_heap:jemalloc]` |
| `005afd869000-005afe0dd000` | .so | `r-xp` | 8656 | 3188 | 3188 | 1196 | 299 | 13.82% | `/data/storage/el1/bundle/libs/arm64/libdyplayer.so` |
| `005a49c01000-005a49e00000` | native heap | `rw-p` | 2044 | 1580 | 1568 | 1016 | 254 | 49.71% | `[anon:native_heap:jemalloc meta]` |
| `005a4962c000-005a497a2000` | FilePage other | `r-xp` | 1496 | 1264 | 9 | 852 | 213 | 56.95% | `/system/lib/ld-musl-aarch64.so.1` |
| `005aeeb0b000-005aef92f000` | FilePage other | `r-xp` | 14480 | 1276 | 62 | 788 | 197 | 5.44% | `/system/lib64/module/arkcompiler/stub.an` |
| `005aee704000-005aee904000` | native heap | `rw-p` | 2048 | 1912 | 1854 | 516 | 129 | 25.20% | `[anon:native_heap:jemalloc]` |
| `005a4a201000-005a4a600000` | native heap | `rw-p` | 4092 | 636 | 632 | 500 | 125 | 12.22% | `[anon:native_heap:jemalloc meta]` |
| `00260b440000-00260b540000` | ark ts heap | `rw-p` | 1024 | 964 | 964 | 492 | 123 | 48.05% | `[anon:ArkTS Heap]` |
| `005c521c4000-005c52544000` | native heap | `rw-p` | 3584 | 2964 | 2964 | 476 | 119 | 13.28% | `[anon:native_heap:jemalloc]` |
| `005c55c15000-005c56014000` | AnonPage other | `rw-p` | 4092 | 4092 | 4092 | 476 | 119 | 11.63% | `(anonymous)` |
| `001e60400000-001e60480000` | ark ts heap | `rw-p` | 512 | 452 | 452 | 440 | 110 | 85.94% | `[anon:ArkTS Heaphuge object space]` |
| `005d2e18a000-005d37761000` | .so | `r-xp` | 153436 | 27324 | 11179 | 432 | 108 | 0.28% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005b00537000-005b0070b000` | .so | `r-xp` | 1872 | 1544 | 1544 | 408 | 102 | 21.79% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `005c4f4e7000-005c4f5e7000` | FilePage other | `rw-p` | 1024 | 1024 | 1024 | 388 | 97 | 37.89% | `[anon:async_stack_table]` |
| `005a4af69000-005a4aff2000` | .so | `r-xp` | 548 | 520 | 4 | 352 | 88 | 64.23% | `/system/lib64/ndk/libffrt.so` |
| `005d18e01000-005d19600000` | native heap | `rw-p` | 8188 | 432 | 432 | 344 | 86 | 4.20% | `[anon:native_heap:jemalloc meta]` |
| `00260dcc0000-00260dd40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 336 | 84 | 65.62% | `[anon:ArkTS Heap]` |
| `005aee401000-005aee600000` | native heap | `rw-p` | 2044 | 332 | 316 | 308 | 77 | 15.07% | `[anon:native_heap:jemalloc meta]` |
| `005d1ec46000-005d1eccf000` | .so | `r-xp` | 548 | 548 | 548 | 304 | 76 | 55.47% | `/data/storage/el1/bundle/libs/arm64/libdanmu.so` |
| `005ad0f80000-005ad0fdd000` | .so | `r-xp` | 372 | 332 | 9 | 284 | 71 | 76.34% | `/system/lib64/platformsdk/libace_napi.z.so` |
| `00260e640000-00260e6c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 276 | 69 | 53.91% | `[anon:ArkTS Heapshared old space]` |
| `005b4d432000-005b4dc7e000` | .hap | `r--p` | 8496 | 7536 | 7533 | 260 | 65 | 3.06% | `/data/storage/el1/bundle/entry.hap` |
| `002608b80000-002608bc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `002609700000-002609740000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `002609bc0000-002609c00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260a540000-00260a580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260ae40000-00260ae80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260be80000-00260bec0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260cec0000-00260cf00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260d180000-00260d1c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260da00000-00260da40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260da80000-00260dac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260e6c0000-00260e700000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260e900000-00260e940000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapshared old space]` |
| `00260f500000-00260f540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heap]` |
| `00260fb80000-00260fbc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapshared old space]` |
| `00260ed80000-00260edc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 248 | 62 | 96.88% | `[anon:ArkTS Heap]` |
| `00260f540000-00260f580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 248 | 62 | 96.88% | `[anon:ArkTS Heapshared old space]` |
| `005ad2f00000-005ad3111000` | .so | `r--p` | 2116 | 612 | 30 | 248 | 62 | 11.72% | `/system/lib64/platformsdk/libark_jsruntime.so` |
| `005a4ab10000-005a4abae000` | .so | `r-xp` | 632 | 416 | 4 | 244 | 61 | 38.61% | `/system/lib64/chipset-sdk-sp/libc++.so` |
| `00260b740000-00260b780000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 240 | 60 | 93.75% | `[anon:ArkTS Heapsemi space]` |
| `00260edc0000-00260ee00000` | ark ts heap | `rw-p` | 256 | 228 | 228 | 228 | 57 | 89.06% | `[anon:ArkTS Heapsemi space]` |
| `002609a00000-002609a40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 220 | 55 | 85.94% | `[anon:ArkTS Heap]` |
| `00260f2c0000-00260f300000` | ark ts heap | `rw-p` | 256 | 256 | 46 | 220 | 55 | 85.94% | `[anon:ArkTS Heapappspawn space]` |
| `00178fdc0000-00178fe00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 216 | 54 | 84.38% | `[anon:ArkTS Heapnon movable space]` |
| `00260f300000-00260f340000` | ark ts heap | `rw-p` | 256 | 256 | 77 | 216 | 54 | 84.38% | `[anon:ArkTS Heapappspawn space]` |
| `00260dc80000-00260dcc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 208 | 52 | 81.25% | `[anon:ArkTS Heapsemi space]` |
| `005adff72000-005ae2f9d000` | .so | `r-xp` | 49324 | 22600 | 3455 | 208 | 52 | 0.42% | `/system/lib64/platformsdk/libace_compatible.z.so` |
| `005adb201000-005adb800000` | native heap | `rw-p` | 6140 | 248 | 193 | 200 | 50 | 3.26% | `[anon:native_heap:jemalloc meta]` |
| `005ae7f80000-005ae7ff4000` | .so | `r--p` | 464 | 264 | 87 | 200 | 50 | 43.10% | `/vendor/lib64/passthrough/libhvgr_v210.so` |
| `005c4e71d000-005c4ea1d000` | native heap | `rw-p` | 3072 | 2932 | 2932 | 200 | 50 | 6.51% | `[anon:native_heap:jemalloc]` |
| `005acc36f000-005acc3c1000` | GL | `r-xp` | 328 | 208 | 1 | 192 | 48 | 58.54% | `/system/lib64/platformsdk/libipc_single.z.so` |
| `00260b540000-00260b580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 184 | 46 | 71.88% | `[anon:ArkTS Heapshared old space]` |
| `00260de40000-00260de80000` | ark ts heap | `rw-p` | 256 | 184 | 184 | 184 | 46 | 71.88% | `[anon:ArkTS Heap]` |
| `00260f880000-00260f8c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 184 | 46 | 71.88% | `[anon:ArkTS Heapshared old space]` |
| `005afd580000-005afd868000` | .so | `r--p` | 2976 | 1608 | 1608 | 184 | 46 | 6.18% | `/data/storage/el1/bundle/libs/arm64/libdyplayer.so` |
| `00178fd80000-00178fdc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 180 | 45 | 70.31% | `[anon:ArkTS Heapnon movable space]` |
| `00260f380000-00260f3c0000` | ark ts heap | `rw-p` | 256 | 256 | 57 | 180 | 45 | 70.31% | `[anon:ArkTS Heapappspawn space]` |
| `002609f80000-002609fc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 176 | 44 | 68.75% | `[anon:ArkTS Heap]` |
| `00260e740000-00260e780000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 176 | 44 | 68.75% | `[anon:ArkTS Heapsemi space]` |
| `00178fe80000-00178fec0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 172 | 43 | 67.19% | `[anon:ArkTS Heapnon movable space]` |
| `002608bc0000-002608c40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 172 | 43 | 33.59% | `[anon:ArkTS Heap]` |
| `00260f200000-00260f240000` | ark ts heap | `rw-p` | 256 | 256 | 53 | 172 | 43 | 67.19% | `[anon:ArkTS Heapappspawn space]` |
| `00260b240000-00260b2c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 168 | 42 | 32.81% | `[anon:ArkTS Heapshared old space]` |
| `005aff6b5000-005aff8d4000` | .so | `r-xp` | 2172 | 512 | 512 | 168 | 42 | 7.73% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `00178ffc0000-001790000000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 164 | 41 | 64.06% | `[anon:ArkTS Heapnon movable space]` |
| `00260f3c0000-00260f400000` | ark ts heap | `rw-p` | 256 | 256 | 53 | 164 | 41 | 64.06% | `[anon:ArkTS Heapappspawn space]` |
| `005ad765b000-005ad782d000` | .so | `r-xp` | 1864 | 1084 | 40 | 164 | 41 | 8.80% | `/system/lib64/chipset-sdk-sp/libcrypto_openssl.z.so` |
| `00260ab00000-00260ab40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 160 | 40 | 62.50% | `[anon:ArkTS Heap]` |
| `00260f1c0000-00260f200000` | ark ts heap | `rw-p` | 256 | 256 | 57 | 160 | 40 | 62.50% | `[anon:ArkTS Heapappspawn space]` |
| `005ae2f9d000-005ae3345000` | .so | `r--p` | 3744 | 1752 | 169 | 160 | 40 | 4.27% | `/system/lib64/platformsdk/libace_compatible.z.so` |
| `005c4db9a000-005c4de1a000` | native heap | `rw-p` | 2560 | 1756 | 1756 | 160 | 40 | 6.25% | `[anon:native_heap:jemalloc]` |
| `002609500000-002609540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 156 | 39 | 60.94% | `[anon:ArkTS Heap]` |
| `005acce14000-005acce41000` | .so | `r-xp` | 180 | 164 | 2 | 156 | 39 | 86.67% | `/system/lib64/chipset-sdk-sp/libeventhandler.z.so` |
| `00260b880000-00260b8c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 152 | 38 | 59.38% | `[anon:ArkTS Heap]` |
| `00260e580000-00260e640000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 152 | 38 | 19.79% | `[anon:ArkTS Heap]` |
| `00178fd00000-00178fd40000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 148 | 37 | 57.81% | `[anon:ArkTS Heapnon movable space]` |
| `00260fb00000-00260fb40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 148 | 37 | 57.81% | `[anon:ArkTS Heap]` |
| `005ace8b3000-005ace905000` | Graph | `r-xp` | 328 | 260 | 13 | 148 | 37 | 45.12% | `/system/lib64/chipset-sdk-sp/libsurface.z.so` |
| `001e60080000-001e60100000` | ark ts heap | `rw-p` | 512 | 456 | 456 | 144 | 36 | 28.12% | `[anon:ArkTS Heapshared huge object space]` |
| `00260a380000-00260a3c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 144 | 36 | 56.25% | `[anon:ArkTS Heap]` |
| `00260bf00000-00260bf40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 144 | 36 | 56.25% | `[anon:ArkTS Heap]` |
| `00260d500000-00260d540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 144 | 36 | 56.25% | `[anon:ArkTS Heap]` |
| `00260f040000-00260f080000` | ark ts heap | `rw-p` | 256 | 256 | 61 | 144 | 36 | 56.25% | `[anon:ArkTS Heapappspawn space]` |
| `00260f100000-00260f140000` | ark ts heap | `rw-p` | 256 | 256 | 26 | 144 | 36 | 56.25% | `[anon:ArkTS Heapappspawn space]` |
| `005adb187000-005adb1fe000` | FilePage other | `rw-p` | 476 | 352 | 26 | 144 | 36 | 30.25% | `/system/etc/abc/framework/stateMgmt.abc` |
| `00178fe00000-00178fe40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 140 | 35 | 54.69% | `[anon:ArkTS Heapnon movable space]` |
| `00260fd00000-00260fd40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 140 | 35 | 54.69% | `[anon:ArkTS Heap]` |
| `00178fec0000-00178ff00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 136 | 34 | 53.12% | `[anon:ArkTS Heapnon movable space]` |
| `00260dd40000-00260dd80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 132 | 33 | 51.56% | `[anon:ArkTS Heap]` |
| `00260f080000-00260f0c0000` | ark ts heap | `rw-p` | 256 | 256 | 46 | 132 | 33 | 51.56% | `[anon:ArkTS Heapappspawn space]` |
| `00260f180000-00260f1c0000` | ark ts heap | `rw-p` | 256 | 256 | 34 | 132 | 33 | 51.56% | `[anon:ArkTS Heapappspawn space]` |
| `002608d40000-002608dc0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 128 | 32 | 25.00% | `[anon:ArkTS Heap]` |
| `00178f800000-00178f840000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 124 | 31 | 48.44% | `[anon:ArkTS Heapnon movable space]` |
| `00260a980000-00260a9c0000` | ark ts heap | `rw-p` | 256 | 124 | 124 | 124 | 31 | 48.44% | `[anon:ArkTS Heapsemi space]` |
| `00260bb40000-00260bc00000` | ark ts heap | `rw-p` | 768 | 528 | 528 | 124 | 31 | 16.15% | `[anon:ArkTS Heap]` |
| `005ae3ea7000-005ae3f62000` | .so | `r-xp` | 748 | 180 | 28 | 124 | 31 | 16.58% | `/system/lib64/platformsdk/libav_codec_client.z.so` |
| `005afe152000-005afe44b000` | FilePage other | `rw-p` | 3044 | 276 | 276 | 124 | 31 | 4.07% | `[anon:libdyplayer.so.bss]` |
| `00178fcc0000-00178fd00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 120 | 30 | 46.88% | `[anon:ArkTS Heapnon movable space]` |
| `00260be40000-00260be80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 120 | 30 | 46.88% | `[anon:ArkTS Heapshared old space]` |
| `00260c7c0000-00260c8c0000` | ark ts heap | `rw-p` | 1024 | 1024 | 1024 | 120 | 30 | 11.72% | `[anon:ArkTS Heapshared old space]` |
| `005a49e01000-005a4a001000` | native heap | `rw-p` | 2048 | 788 | 363 | 120 | 30 | 5.86% | `[anon:native_heap:jemalloc]` |
| `005afe0dd000-005afe14b000` | .so | `r--p` | 440 | 440 | 440 | 120 | 30 | 27.27% | `/data/storage/el1/bundle/libs/arm64/libdyplayer.so` |
| `00178f5c0000-00178f600000` | ark ts heap | `rw-p` | 256 | 180 | 180 | 112 | 28 | 43.75% | `[anon:ArkTS Heapnon movable space]` |
| `00260c440000-00260c480000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 112 | 28 | 43.75% | `[anon:ArkTS Heap]` |
| `00260f0c0000-00260f100000` | ark ts heap | `rw-p` | 256 | 256 | 34 | 112 | 28 | 43.75% | `[anon:ArkTS Heapappspawn space]` |
| `002609940000-002609980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 108 | 27 | 42.19% | `[anon:ArkTS Heapsemi space]` |
| `00260a180000-00260a200000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 108 | 27 | 21.09% | `[anon:ArkTS Heap]` |
| `00260afc0000-00260b000000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 108 | 27 | 42.19% | `[anon:ArkTS Heap]` |
| `00260cb00000-00260cb40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 108 | 27 | 42.19% | `[anon:ArkTS Heap]` |
| `00260e980000-00260e9c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 108 | 27 | 42.19% | `[anon:ArkTS Heap]` |
| `00260f280000-00260f2c0000` | ark ts heap | `rw-p` | 256 | 256 | 30 | 108 | 27 | 42.19% | `[anon:ArkTS Heapappspawn space]` |
| `00260f780000-00260f7c0000` | ark ts heap | `rw-p` | 256 | 148 | 97 | 108 | 27 | 42.19% | `[anon:ArkTS Heapshared appspawn space]` |
| `00178f600000-00178f680000` | ark ts heap | `rw-p` | 512 | 392 | 392 | 104 | 26 | 20.31% | `[anon:ArkTS Heapnon movable space]` |
| `00178fac0000-00178fb00000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 104 | 26 | 40.62% | `[anon:ArkTS Heapnon movable space]` |
| `00260ad80000-00260adc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 104 | 26 | 40.62% | `[anon:ArkTS Heap]` |
| `00260e9c0000-00260ea40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 104 | 26 | 20.31% | `[anon:ArkTS Heap]` |
| `00260bfc0000-00260c000000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 100 | 25 | 39.06% | `[anon:ArkTS Heap]` |
| `00260ef80000-00260efc0000` | ark ts heap | `rw-p` | 256 | 256 | 61 | 100 | 25 | 39.06% | `[anon:ArkTS Heapappspawn space]` |
| `00178f7c0000-00178f800000` | ark ts heap | `rw-p` | 256 | 244 | 244 | 96 | 24 | 37.50% | `[anon:ArkTS Heapnon movable space]` |
| `0026092c0000-002609340000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 96 | 24 | 18.75% | `[anon:ArkTS Heap]` |
| `00260f9c0000-00260fa00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 96 | 24 | 37.50% | `[anon:ArkTS Heap]` |
| `00178fd40000-00178fd80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 92 | 23 | 35.94% | `[anon:ArkTS Heapnon movable space]` |
| `00178fe40000-00178fe80000` | ark ts heap | `rw-p` | 256 | 240 | 240 | 92 | 23 | 35.94% | `[anon:ArkTS Heapnon movable space]` |
| `00260a040000-00260a080000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 92 | 23 | 35.94% | `[anon:ArkTS Heap]` |
| `00260c040000-00260c140000` | ark ts heap | `rw-p` | 1024 | 1024 | 1024 | 92 | 23 | 8.98% | `[anon:ArkTS Heap]` |
| `00260e480000-00260e500000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 92 | 23 | 17.97% | `[anon:ArkTS Heap]` |
| `005ada666000-005ada68c000` | GL | `r-xp` | 152 | 152 | 11 | 92 | 23 | 60.53% | `/system/lib64/libEGL.so` |
| `00260ed40000-00260ed80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 88 | 22 | 34.38% | `[anon:ArkTS Heap]` |
| `00260f140000-00260f180000` | ark ts heap | `rw-p` | 256 | 256 | 18 | 88 | 22 | 34.38% | `[anon:ArkTS Heapappspawn space]` |
| `00260f600000-00260f640000` | ark ts heap | `rw-p` | 256 | 256 | 119 | 88 | 22 | 34.38% | `[anon:ArkTS Heapshared appspawn space]` |
| `00260ff00000-00260ff40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 88 | 22 | 34.38% | `[anon:ArkTS Heap]` |
| `005a4ad52000-005a4ad83000` | .so | `r-xp` | 196 | 100 | 0 | 88 | 22 | 44.90% | `/system/lib64/libhilog_inner.so` |
| `005afb891000-005afb92b000` | .so | `r-xp` | 616 | 248 | 248 | 88 | 22 | 14.29% | `/data/storage/el1/bundle/libs/arm64/libc++_shared.so` |
| `00260a200000-00260a240000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 84 | 21 | 32.81% | `[anon:ArkTS Heapshared old space]` |
| `00260fa40000-00260fa80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 84 | 21 | 32.81% | `[anon:ArkTS Heap]` |
| `003800004000-003800174000` | FilePage other | `rw-p` | 1472 | 468 | 468 | 84 | 21 | 5.71% | `[anon:partition_alloc]` |
| `005acc710000-005acc73d000` | .so | `r-xp` | 180 | 124 | 1 | 84 | 21 | 46.67% | `/system/lib64/chipset-sdk-sp/libhicollie.z.so` |
| `005acedd8000-005acee75000` | .so | `r-xp` | 628 | 552 | 23 | 84 | 21 | 13.38% | `/system/lib64/platformsdk/libappkit_native.z.so` |
| `002608c80000-002608d00000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 80 | 20 | 15.62% | `[anon:ArkTS Heap]` |
| `00260ae80000-00260af40000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 80 | 20 | 10.42% | `[anon:ArkTS Heap]` |
| `00260eb00000-00260eb40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 80 | 20 | 31.25% | `[anon:ArkTS Heapsemi space]` |
| `00260f800000-00260f840000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 80 | 20 | 31.25% | `[anon:ArkTS Heap]` |
| `005ad1010000-005ad102f000` | .so | `r-xp` | 124 | 124 | 3 | 80 | 20 | 64.52% | `/system/lib64/platformsdk/libuv.so` |
| `00178f780000-00178f7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 76 | 19 | 29.69% | `[anon:ArkTS Heapnon movable space]` |
| `002609880000-0026098c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 76 | 19 | 29.69% | `[anon:ArkTS Heapshared old space]` |
| `00260f000000-00260f040000` | ark ts heap | `rw-p` | 256 | 256 | 18 | 76 | 19 | 29.69% | `[anon:ArkTS Heapappspawn space]` |
| `005a49593000-005a4962c000` | FilePage other | `r--p` | 612 | 260 | 3 | 76 | 19 | 12.42% | `/system/lib/ld-musl-aarch64.so.1` |
| `005a4ac17000-005a4ac36000` | .so | `r-xp` | 124 | 112 | 0 | 76 | 19 | 61.29% | `/system/lib64/chipset-sdk-sp/libutils.z.so` |
| `002608f40000-002609000000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 72 | 18 | 9.38% | `[anon:ArkTS Heap]` |
| `00260d680000-00260d6c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 72 | 18 | 28.12% | `[anon:ArkTS Heap]` |
| `00260df80000-00260dfc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 72 | 18 | 28.12% | `[anon:ArkTS Heap]` |
| `005ae3638000-005ae368e000` | .so | `r-xp` | 344 | 116 | 17 | 72 | 18 | 20.93% | `/system/lib64/platformsdk/libaudio_common.z.so` |
| `005ae40f9000-005ae413d000` | .so | `r-xp` | 272 | 128 | 25 | 72 | 18 | 26.47% | `/system/lib64/platformsdk/libaudio_stream_client.z.so` |
| `005c4df1a000-005c4e61a000` | FilePage other | `rw-p` | 7168 | 436 | 436 | 72 | 18 | 1.00% | `[anon:ffrt_coroutine_stack]` |
| `002609dc0000-002609e00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 68 | 17 | 26.56% | `[anon:ArkTS Heapshared old space]` |
| `00260eb40000-00260ebc0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 68 | 17 | 13.28% | `[anon:ArkTS Heap]` |
| `00260ee80000-00260eec0000` | ark ts heap | `rw-p` | 256 | 256 | 93 | 68 | 17 | 26.56% | `[anon:ArkTS Heapappspawn space]` |
| `00260efc0000-00260f000000` | ark ts heap | `rw-p` | 256 | 256 | 84 | 68 | 17 | 26.56% | `[anon:ArkTS Heapappspawn space]` |
| `005aff8d4000-005aff8f2000` | .so | `r--p` | 120 | 120 | 120 | 68 | 17 | 56.67% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `005b0a58d000-005b0a5b1000` | .so | `r-xp` | 144 | 132 | 19 | 68 | 17 | 47.22% | `/system/lib64/module/libworker.z.so` |
| `005d2d240000-005d2e18a000` | .so | `r--p` | 15656 | 7200 | 2079 | 68 | 17 | 0.43% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `00178f840000-00178f880000` | ark ts heap | `rw-p` | 256 | 140 | 140 | 64 | 16 | 25.00% | `[anon:ArkTS Heapnon movable space]` |
| `002608e00000-002608e80000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 64 | 16 | 12.50% | `[anon:ArkTS Heap]` |
| `00260c600000-00260c640000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 64 | 16 | 25.00% | `[anon:ArkTS Heap]` |
| `00260cc80000-00260cd40000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 64 | 16 | 8.33% | `[anon:ArkTS Heapshared old space]` |
| `00260ee00000-00260ee40000` | ark ts heap | `rw-p` | 256 | 188 | 75 | 64 | 16 | 25.00% | `[anon:ArkTS Heapappspawn space]` |
| `00260fd40000-00260fd80000` | ark ts heap | `rw-p` | 256 | 256 | 124 | 64 | 16 | 25.00% | `[anon:ArkTS Heapshared appspawn space]` |
| `005acec61000-005acecc5000` | .so | `r-xp` | 400 | 184 | 6 | 64 | 16 | 16.00% | `/system/lib64/platformsdk/libdatashare_consumer.z.so` |
| `005ad1c43000-005ad1c95000` | .so | `r-xp` | 328 | 300 | 10 | 64 | 16 | 19.51% | `/system/lib64/platformsdk/libruntime.z.so` |
| `005ad2646000-005ad26ba000` | .so | `r-xp` | 464 | 152 | 13 | 64 | 16 | 13.79% | `/system/lib64/platformsdk/libmedia_foundation.z.so` |
| `005ad6dd9000-005ad6e14000` | .so | `r-xp` | 236 | 76 | 2 | 64 | 16 | 27.12% | `/system/lib64/platformsdk/libdatashare_common.z.so` |
| `005d380d1000-005d3824e000` | FilePage other | `rw-p` | 1524 | 360 | 360 | 64 | 16 | 4.20% | `[anon:libarkweb_engine.so.bss]` |
| `00260a940000-00260a980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 60 | 15 | 23.44% | `[anon:ArkTS Heap]` |
| `00260bac0000-00260bb00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 60 | 15 | 23.44% | `[anon:ArkTS Heap]` |
| `00260d640000-00260d680000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 60 | 15 | 23.44% | `[anon:ArkTS Heap]` |
| `003c00a04000-003c00bf8000` | FilePage other | `rw-p` | 2000 | 968 | 968 | 60 | 15 | 3.00% | `[anon:partition_alloc]` |
| `005afb65e000-005afb6c6000` | .so | `r-xp` | 416 | 348 | 51 | 60 | 15 | 14.42% | `/system/lib64/module/net/libhttp.z.so` |
| `00260ab80000-00260abc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 56 | 14 | 21.88% | `[anon:ArkTS Heap]` |
| `00260c6c0000-00260c700000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 56 | 14 | 21.88% | `[anon:ArkTS Heap]` |
| `00260ca80000-00260cac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 56 | 14 | 21.88% | `[anon:ArkTS Heap]` |
| `00260d540000-00260d5c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 56 | 14 | 10.94% | `[anon:ArkTS Heapshared old space]` |
| `00260e300000-00260e340000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 56 | 14 | 21.88% | `[anon:ArkTS Heap]` |
| `005af967d000-005af975e000` | FilePage other | `rw-p` | 900 | 900 | 900 | 56 | 14 | 6.22% | `[anon:ArkTS MethodLiteral]` |
| `005d37761000-005d37fdc000` | .so | `r--p` | 8684 | 8668 | 8668 | 56 | 14 | 0.64% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `00260c500000-00260c540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 52 | 13 | 20.31% | `[anon:ArkTS Heap]` |
| `00260e280000-00260e2c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 52 | 13 | 20.31% | `[anon:ArkTS Heap]` |
| `00260e700000-00260e740000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 52 | 13 | 20.31% | `[anon:ArkTS Heap]` |
| `005ad6813000-005ad6849000` | .so | `r-xp` | 216 | 116 | 4 | 52 | 13 | 24.07% | `/system/lib64/platformsdk/libnative_preferences.z.so` |
| `005ad7500000-005ad765b000` | .so | `r--p` | 1388 | 612 | 25 | 52 | 13 | 3.75% | `/system/lib64/chipset-sdk-sp/libcrypto_openssl.z.so` |
| `005ad782d000-005ad788e000` | .so | `r--p` | 388 | 340 | 15 | 52 | 13 | 13.40% | `/system/lib64/chipset-sdk-sp/libcrypto_openssl.z.so` |
| `00260b5c0000-00260b600000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heap]` |
| `00260bec0000-00260bf00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heapshared old space]` |
| `00260de80000-00260dec0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heap]` |
| `00260e140000-00260e180000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heap]` |
| `00260e940000-00260e980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heapshared old space]` |
| `005a4ac00000-005a4ac17000` | .so | `r--p` | 92 | 52 | 1 | 48 | 12 | 52.17% | `/system/lib64/chipset-sdk-sp/libutils.z.so` |
| `005acd1c6000-005acd1d5000` | .so | `r-xp` | 60 | 48 | 0 | 48 | 12 | 80.00% | `/system/lib64/platformsdk/libzuri.z.so` |
| `00178f900000-00178f940000` | ark ts heap | `rw-p` | 256 | 208 | 208 | 44 | 11 | 17.19% | `[anon:ArkTS Heapnon movable space]` |
| `001e60000000-001e60080000` | ark ts heap | `rw-p` | 512 | 456 | 456 | 44 | 11 | 8.59% | `[anon:ArkTS Heaphuge object space]` |
| `0026093c0000-002609400000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heap]` |
| `00260cf00000-00260cf40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heap]` |
| `00260ef40000-00260ef80000` | ark ts heap | `rw-p` | 256 | 256 | 57 | 44 | 11 | 17.19% | `[anon:ArkTS Heapappspawn space]` |
| `00260f680000-00260f6c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heap]` |
| `00260fbc0000-00260fc00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heap]` |
| `003c00804000-003c009fc000` | FilePage other | `rw-p` | 2016 | 1660 | 1660 | 44 | 11 | 2.18% | `[anon:partition_alloc]` |
| `005a497af000-005a49a9b000` | FilePage other | `rw-p` | 2992 | 64 | 64 | 44 | 11 | 1.47% | `[anon:ld-musl-aarch64.so.1.bss]` |
| `005ad38ba000-005ad38d5000` | .so | `r--p` | 108 | 84 | 2 | 44 | 11 | 40.74% | `/system/lib64/platformsdk/libark_jsruntime.so` |
| `005afe4a1000-005afe4cc000` | .so | `r-xp` | 172 | 72 | 5 | 44 | 11 | 25.58% | `/system/lib64/ndk/libohaudio.so` |
| `00178fa00000-00178fa40000` | ark ts heap | `rw-p` | 256 | 180 | 180 | 40 | 10 | 15.62% | `[anon:ArkTS Heapnon movable space]` |
| `00260a280000-00260a300000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 40 | 10 | 7.81% | `[anon:ArkTS Heap]` |
| `00260c300000-00260c340000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heap]` |
| `00260e2c0000-00260e300000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heap]` |
| `00260eac0000-00260eb00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heap]` |
| `00260f8c0000-00260f900000` | ark ts heap | `rw-p` | 256 | 172 | 86 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared appspawn space]` |
| `00260fdc0000-00260fe00000` | ark ts heap | `rw-p` | 256 | 256 | 69 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared appspawn space]` |
| `00260ffc0000-002610000000` | ark ts heap | `rw-p` | 256 | 256 | 81 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared appspawn space]` |
| `003c00004000-003c001fc000` | FilePage other | `rw-p` | 2016 | 1620 | 1620 | 40 | 10 | 1.98% | `[anon:partition_alloc]` |
| `003c00204000-003c003f4000` | FilePage other | `rw-p` | 1984 | 1316 | 1316 | 40 | 10 | 2.02% | `[anon:partition_alloc]` |
| `005a4aec3000-005a4aecf000` | .so | `r-xp` | 48 | 48 | 0 | 40 | 10 | 83.33% | `/system/lib64/chipset-sdk-sp/libsec_shared.z.so` |
| `005a4aff8000-005a4b009000` | FilePage other | `rw-p` | 68 | 40 | 40 | 40 | 10 | 58.82% | `[anon:libffrt.so.bss]` |
...
| `005aded9d000-005adedc8000` | GL | `r-xp` | 172 | 100 | 28 | 40 | 10 | 23.26% | `/system/lib64/platformsdk/libaudio_renderer.z.so` |
| `005ae3fa0000-005ae3fe8000` | .so | `r-xp` | 288 | 120 | 18 | 40 | 10 | 13.89% | `/system/lib64/platformsdk/libaudio_utils.z.so` |
| `005b06f89000-005b06fa7000` | .so | `r-xp` | 120 | 76 | 5 | 40 | 10 | 33.33% | `/system/lib64/module/data/libpreferences.z.so` |
| `005b09f90000-005b09faf000` | .so | `r-xp` | 124 | 92 | 9 | 40 | 10 | 32.26% | `/system/lib64/platformsdk/libsensor_client.z.so` |
| `005b0a10b000-005b0a12c000` | .so | `r-xp` | 132 | 40 | 3 | 40 | 10 | 30.30% | `/system/lib64/module/libsettings.z.so` |
| `005c54ffb000-005c550fc000` | FilePage other | `rw-p` | 1028 | 80 | 80 | 40 | 10 | 3.89% | `[anon:stack:30092]` |
| `00178ff40000-00178ff80000` | ark ts heap | `rw-p` | 256 | 160 | 148 | 36 | 9 | 14.06% | `[anon:ArkTS Heapshared non movable space]` |
| `00178ff80000-00178ffc0000` | ark ts heap | `rw-p` | 256 | 44 | 28 | 36 | 9 | 14.06% | `[anon:ArkTS Heapshared read only space]` |
| `002609a40000-002609a80000` | ark ts heap | `rw-p` | 256 | 36 | 36 | 36 | 9 | 14.06% | `[anon:ArkTS Heap]` |
| `00260af40000-00260af80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 36 | 9 | 14.06% | `[anon:ArkTS Heapshared old space]` |
| `00260b6c0000-00260b740000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 36 | 9 | 7.03% | `[anon:ArkTS Heapshared old space]` |
| `00260cd80000-00260cdc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 36 | 9 | 14.06% | `[anon:ArkTS Heapsemi space]` |
| `00260e040000-00260e080000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 36 | 9 | 14.06% | `[anon:ArkTS Heap]` |
| `00260f340000-00260f380000` | ark ts heap | `rw-p` | 256 | 256 | 53 | 36 | 9 | 14.06% | `[anon:ArkTS Heapappspawn space]` |
| `00260fc00000-00260fc40000` | ark ts heap | `rw-p` | 256 | 80 | 80 | 36 | 9 | 14.06% | `[anon:ArkTS Heapsemi space]` |
| `003c00c04000-003c00cd4000` | FilePage other | `rw-p` | 832 | 188 | 188 | 36 | 9 | 4.33% | `[anon:partition_alloc]` |
| `005a4a0c5000-005a4a0d1000` | .so | `r-xp` | 48 | 36 | 0 | 36 | 9 | 75.00% | `/system/lib64/chipset-sdk-sp/libhitrace_meter.so` |
| `005acecc5000-005acecd5000` | .so | `r--p` | 64 | 52 | 1 | 36 | 9 | 56.25% | `/system/lib64/platformsdk/libdatashare_consumer.z.so` |
| `005b004c0000-005b00537000` | .so | `r--p` | 476 | 240 | 240 | 36 | 9 | 7.56% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `005d1ebc0000-005d1ec46000` | .so | `r--p` | 536 | 448 | 448 | 36 | 9 | 6.72% | `/data/storage/el1/bundle/libs/arm64/libdanmu.so` |
| `005d1fc7a000-005d2047b000` | FilePage other | `rw-p` | 8196 | 48 | 48 | 36 | 9 | 0.44% | `[anon:stack:30256]` |
| `00260bc40000-00260bc80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heapshared old space]` |
| `00260bf80000-00260bfc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heapshared old space]` |
| `00260c700000-00260c780000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 32 | 8 | 6.25% | `[anon:ArkTS Heapshared old space]` |
| `00260ee40000-00260ee80000` | ark ts heap | `rw-p` | 256 | 256 | 62 | 32 | 8 | 12.50% | `[anon:ArkTS Heapappspawn space]` |
| `00260f4c0000-00260f500000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heapshared old space]` |
| `00260f5c0000-00260f600000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heap]` |
| `005acd20e000-005acd232000` | .so | `r-xp` | 144 | 68 | 2 | 32 | 8 | 22.22% | `/system/lib64/libhap_restorecon.z.so` |
| `005ad1f4d000-005ad1f7b000` | FilePage other | `rw-p` | 184 | 184 | 184 | 32 | 8 | 17.39% | `[anon:ArkTS Code:396560407104]` |
| `005ae33f9000-005ae34b9000` | FilePage other | `rw-p` | 768 | 316 | 286 | 32 | 8 | 4.17% | `[anon:libace_compatible.z.so.bss]` |
| `005ae3f62000-005ae3f6f000` | .so | `r--p` | 52 | 40 | 15 | 32 | 8 | 61.54% | `/system/lib64/platformsdk/libav_codec_client.z.so` |
| `005aff480000-005aff6b5000` | .so | `r--p` | 2260 | 1608 | 1608 | 32 | 8 | 1.42% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `005b0070b000-005b00715000` | .so | `r--p` | 40 | 40 | 40 | 32 | 8 | 80.00% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `005b06fc8000-005b06fd4000` | .so | `r-xp` | 48 | 36 | 2 | 32 | 8 | 66.67% | `/system/lib64/libpreferences_jscommon.z.so` |
| `007f686cb000-007f68ec8000` | stack | `rw-p` | 8180 | 100 | 100 | 32 | 8 | 0.39% | `[stack]` |
| `002608dc0000-002608e00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heapshared old space]` |
| `002609840000-002609880000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260a4c0000-00260a500000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260b100000-00260b140000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260cfc0000-00260d000000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260e8c0000-00260e900000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260ea80000-00260eac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260eec0000-00260ef00000` | ark ts heap | `rw-p` | 256 | 256 | 26 | 28 | 7 | 10.94% | `[anon:ArkTS Heapappspawn space]` |
| `005accb1f000-005accb5e000` | .so | `r-xp` | 252 | 40 | 1 | 28 | 7 | 11.11% | `/system/lib64/platformsdk/libos_account_innerkits.z.so` |
...
| `005ae4e83000-005ae5183000` | native heap | `rw-p` | 3072 | 400 | 131 | 28 | 7 | 0.91% | `[anon:native_heap:jemalloc]` |
| `005afd4c4000-005afd4cb000` | .so | `r-xp` | 28 | 28 | 2 | 28 | 7 | 100.00% | `/system/lib64/libnative_media_vdec.so` |
| `005affab8000-005affae9000` | GL | `r-xp` | 196 | 88 | 88 | 28 | 7 | 14.29% | `/data/storage/el1/bundle/libs/arm64/libreact_render_scheduler.so` |
| `005b002a0000-005b00314000` | .so | `r-xp` | 464 | 332 | 332 | 28 | 7 | 6.03% | `/data/storage/el1/bundle/libs/arm64/librnoh_app.so` |
| `005b09fcc000-005b09fd7000` | .so | `r-xp` | 44 | 40 | 4 | 28 | 7 | 63.64% | `/system/lib64/platformsdk/libsensor_utils.z.so` |
| `005b0a049000-005b0a06a000` | .so | `r-xp` | 132 | 60 | 22 | 28 | 7 | 21.21% | `/system/lib64/module/libsensor.z.so` |
| `005b0a349000-005b0a362000` | .so | `r-xp` | 100 | 88 | 6 | 28 | 7 | 28.00% | `/system/lib64/module/libutil.z.so` |
| `005c4f707000-005c4f725000` | .so | `r-xp` | 120 | 80 | 3 | 28 | 7 | 23.33% | `/system/lib64/libframeawaresched.so` |
| `005d1e482000-005d1e782000` | FilePage other | `rw-p` | 3072 | 176 | 176 | 28 | 7 | 0.91% | `[anon:ffrt_coroutine_stack]` |
| `005d20683000-005d20784000` | FilePage other | `rw-p` | 1028 | 52 | 52 | 28 | 7 | 2.72% | `[anon:stack:30279]` |
| `00178f740000-00178f780000` | ark ts heap | `rw-p` | 256 | 232 | 232 | 24 | 6 | 9.38% | `[anon:ArkTS Heapnon movable space]` |
| `00260d1c0000-00260d200000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heapshared old space]` |
| `00260d5c0000-00260d600000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heap]` |
| `00260ea40000-00260ea80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heapshared old space]` |
| `00260ed00000-00260ed40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heapshared old space]` |
| `003c00604000-003c007c0000` | FilePage other | `rw-p` | 1776 | 1056 | 1056 | 24 | 6 | 1.35% | `[anon:partition_alloc]` |
| `005a497a2000-005a497aa000` | FilePage other | `r--p` | 32 | 24 | 1 | 24 | 6 | 75.00% | `/system/lib/ld-musl-aarch64.so.1` |
| `005a4abae000-005a4abb9000` | .so | `r--p` | 44 | 28 | 0 | 24 | 6 | 54.55% | `/system/lib64/chipset-sdk-sp/libc++.so` |
...
| `005ad26ba000-005ad26c2000` | .so | `r--p` | 32 | 28 | 6 | 24 | 6 | 75.00% | `/system/lib64/platformsdk/libmedia_foundation.z.so` |
...
| `005ae8580000-005ae860a000` | .so | `r--p` | 552 | 36 | 5 | 24 | 6 | 4.35% | `/vendor/lib64/passthrough/libhvgr_v210.so` |
| `005b00314000-005b00323000` | .so | `r--p` | 60 | 60 | 60 | 24 | 6 | 40.00% | `/data/storage/el1/bundle/libs/arm64/librnoh_app.so` |
| `005b0242d000-005b02461000` | .so | `r-xp` | 208 | 56 | 56 | 24 | 6 | 11.54% | `/data/storage/el1/bundle/libs/arm64/libjsi.so` |
| `005d1eccf000-005d1ecd5000` | .so | `r--p` | 24 | 24 | 24 | 24 | 6 | 100.00% | `/data/storage/el1/bundle/libs/arm64/libdanmu.so` |
| `00178fb80000-00178fbc0000` | ark ts heap | `rw-p` | 256 | 144 | 144 | 20 | 5 | 7.81% | `[anon:ArkTS Heapnon movable space]` |
| `00260b2c0000-00260b340000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 20 | 5 | 3.91% | `[anon:ArkTS Heapshared old space]` |
| `00260b3c0000-00260b440000` | ark ts heap | `rw-p` | 512 | 508 | 508 | 20 | 5 | 3.91% | `[anon:ArkTS Heapshared old space]` |
| `00260b8c0000-00260b980000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 20 | 5 | 2.60% | `[anon:ArkTS Heapshared old space]` |
| `00260c180000-00260c200000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 20 | 5 | 3.91% | `[anon:ArkTS Heapshared old space]` |
| `00260d440000-00260d480000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapshared old space]` |
| `00260da40000-00260da80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapshared old space]` |
| `00260f240000-00260f280000` | ark ts heap | `rw-p` | 256 | 256 | 38 | 20 | 5 | 7.81% | `[anon:ArkTS Heapappspawn space]` |
| `00260fcc0000-00260fd00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapshared old space]` |
| `00260ff40000-00260ff80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heap]` |
| `003c00404000-003c005f8000` | FilePage other | `rw-p` | 2000 | 1084 | 1084 | 20 | 5 | 1.00% | `[anon:partition_alloc]` |
| `005a4a0d3000-005a4a0df000` | native heap | `rw-p` | 48 | 32 | 1 | 20 | 5 | 41.67% | `[anon:native_heap:brk]` |
| `005a4aa80000-005a4ab10000` | .so | `r--p` | 576 | 260 | 8 | 20 | 5 | 3.47% | `/system/lib64/chipset-sdk-sp/libc++.so` |
| `005a4ae47000-005a4ae5d000` | .so | `r-xp` | 88 | 24 | 1 | 20 | 5 | 22.73% | `/system/lib64/chipset-sdk-sp/libbacktrace_local.so` |
...
| `005acce00000-005acce14000` | .so | `r--p` | 80 | 40 | 1 | 20 | 5 | 25.00% | `/system/lib64/chipset-sdk-sp/libeventhandler.z.so` |
| `005acee75000-005acee80000` | .so | `r--p` | 44 | 44 | 1 | 20 | 5 | 45.45% | `/system/lib64/platformsdk/libappkit_native.z.so` |
| `005ad1c00000-005ad1c43000` | .so | `r--p` | 268 | 124 | 4 | 20 | 5 | 7.46% | `/system/lib64/platformsdk/libruntime.z.so` |
| `005ad1f45000-005ad1f4b000` | .so | `r-xp` | 24 | 20 | 1 | 20 | 5 | 83.33% | `/system/lib64/ndk/libsync_fence.z.so` |
| `005ad6f23000-005ad6f48000` | .so | `r-xp` | 148 | 64 | 3 | 20 | 5 | 13.51% | `/system/lib64/platformsdk/libability_context_native.z.so` |
| `005ada640000-005ada666000` | GL | `r--p` | 152 | 128 | 8 | 20 | 5 | 13.16% | `/system/lib64/libEGL.so` |
| `005ae3345000-005ae33f9000` | .so | `rw-p` | 720 | 376 | 162 | 20 | 5 | 2.78% | `/system/lib64/platformsdk/libace_compatible.z.so` |
| `005ae3600000-005ae3638000` | .so | `r--p` | 224 | 52 | 5 | 20 | 5 | 8.93% | `/system/lib64/platformsdk/libaudio_common.z.so` |
| `005afb92b000-005afb936000` | .so | `r--p` | 44 | 44 | 44 | 20 | 5 | 45.45% | `/data/storage/el1/bundle/libs/arm64/libc++_shared.so` |
| `005b0a100000-005b0a10b000` | .so | `r--p` | 44 | 20 | 1 | 20 | 5 | 45.45% | `/system/lib64/module/libsettings.z.so` |
| `005c55815000-005c55c14000` | AnonPage other | `rw-p` | 4092 | 4092 | 4092 | 20 | 5 | 0.49% | `(anonymous)` |
| `005c56015000-005c56400000` | AnonPage other | `rw-p` | 4012 | 2852 | 2852 | 20 | 5 | 0.50% | `(anonymous)` |
| `005d1f34b000-005d1f358000` | Graph | `r-xp` | 52 | 52 | 15 | 20 | 5 | 38.46% | `/system/lib64/libgameservice_graphic_plugin.z.so` |
| `005d37fe0000-005d380d1000` | .so | `rw-p` | 964 | 580 | 580 | 20 | 5 | 2.07% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005d38bdb000-005d38bef000` | GL | `r--p` | 80 | 80 | 80 | 20 | 5 | 25.00% | `/system/lib64/libohos_adapter_glue_source.z.so` |
| `002608f00000-002608f40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heapshared old space]` |
| `002609c80000-002609cc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260b780000-00260b7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heapshared old space]` |
| `00260df40000-00260df80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heapsemi space]` |
| `00260e180000-00260e1c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heapshared old space]` |
| `00260e880000-00260e8c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260ef00000-00260ef40000` | ark ts heap | `rw-p` | 256 | 256 | 26 | 16 | 4 | 6.25% | `[anon:ArkTS Heapappspawn space]` |
| `00260f640000-00260f680000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260f700000-00260f740000` | ark ts heap | `rw-p` | 256 | 184 | 184 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260f980000-00260f9c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260fa80000-00260fac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260fe00000-00260fe40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260fe40000-00260fe80000` | ark ts heap | `rw-p` | 256 | 48 | 24 | 16 | 4 | 6.25% | `[anon:ArkTS Heapshared appspawn space]` |
| `005a4a0c0000-005a4a0c5000` | .so | `r--p` | 20 | 16 | 0 | 16 | 4 | 80.00% | `/system/lib64/chipset-sdk-sp/libhitrace_meter.so` |
| `005a4ad40000-005a4ad52000` | .so | `r--p` | 72 | 20 | 0 | 16 | 4 | 22.22% | `/system/lib64/libhilog_inner.so` |
| `005a4adc5000-005a4adcd000` | .so | `r-xp` | 32 | 24 | 0 | 16 | 4 | 50.00% | `/system/lib64/chipset-sdk-sp/libhitracechain.so` |
| `005acc3c1000-005acc3c6000` | GL | `r--p` | 20 | 16 | 0 | 16 | 4 | 80.00% | `/system/lib64/platformsdk/libipc_single.z.so` |
| `005ace880000-005ace8b3000` | Graph | `r--p` | 204 | 84 | 4 | 16 | 4 | 7.84% | `/system/lib64/chipset-sdk-sp/libsurface.z.so` |
| `005ad0f40000-005ad0f80000` | .so | `r--p` | 256 | 140 | 6 | 16 | 4 | 6.25% | `/system/lib64/platformsdk/libace_napi.z.so` |
| `005ad1f40000-005ad1f45000` | .so | `r--p` | 20 | 16 | 0 | 16 | 4 | 80.00% | `/system/lib64/ndk/libsync_fence.z.so` |
| `005ad6e1a000-005ad6e40000` | dev | `rw-s` | 152 | 152 | 152 | 16 | 4 | 10.53% | `anon_inode:dev/ashmem/EXTRawData` |
| `005ada68c000-005ada69a000` | GL | `r--p` | 56 | 28 | 4 | 16 | 4 | 28.57% | `/system/lib64/libEGL.so` |
| `005ada700000-005ada71f000` | GL | `r--p` | 124 | 36 | 1 | 16 | 4 | 12.90% | `/system/lib64/libGLESv3.so` |
...
| `005af8206000-005af8506000` | FilePage other | `rw-p` | 3072 | 48 | 48 | 16 | 4 | 0.52% | `[anon:ffrt_coroutine_stack]` |
| `005c4f249000-005c4f258000` | .so | `r-xp` | 60 | 60 | 6 | 16 | 4 | 26.67% | `/system/lib64/libaps_client.z.so` |
| `005d18c9f000-005d18cce000` | .so | `r-xp` | 188 | 164 | 14 | 16 | 4 | 8.51% | `/system/lib64/platformsdk/libhttp_client.z.so` |
| `005d21395000-005d21496000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 16 | 4 | 1.56% | `[anon:stack:30326]` |
| `005d38afe000-005d38bdb000` | GL | `r-xp` | 884 | 240 | 23 | 16 | 4 | 1.81% | `/system/lib64/libohos_adapter_glue_source.z.so` |
| `0026096c0000-002609700000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260a700000-00260a740000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heap]` |
| `00260ad00000-00260ad80000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 12 | 3 | 2.34% | `[anon:ArkTS Heapshared old space]` |
| `00260cd40000-00260cd80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260cf80000-00260cfc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260d4c0000-00260d500000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260dac0000-00260db00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heap]` |
| `00260e1c0000-00260e200000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heap]` |
| `00260ebc0000-00260ec00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
...
| `005acc340000-005acc36f000` | GL | `r--p` | 188 | 116 | 3 | 12 | 3 | 6.38% | `/system/lib64/platformsdk/libipc_single.z.so` |
| `005acc700000-005acc710000` | .so | `r--p` | 64 | 40 | 0 | 12 | 3 | 18.75% | `/system/lib64/chipset-sdk-sp/libhicollie.z.so` |
...
| `005aced40000-005acedd8000` | .so | `r--p` | 608 | 148 | 22 | 12 | 3 | 1.97% | `/system/lib64/platformsdk/libappkit_native.z.so` |
| `005acf300000-005acf308000` | .so | `r--p` | 32 | 16 | 0 | 12 | 3 | 37.50% | `/system/lib64/platformsdk/libconsole.z.so` |
| `005ad103b000-005ad103f000` | dev | `rw-s` | 16 | 16 | 16 | 12 | 3 | 75.00% | `anon_inode:dev/ashmem/EXTRawData` |
...
| `005ad65cf000-005ad65f5000` | dev | `rw-s` | 152 | 152 | 152 | 12 | 3 | 7.89% | `anon_inode:dev/ashmem/EXTRawData` |
| `005ad6849000-005ad684d000` | .so | `r--p` | 16 | 16 | 0 | 12 | 3 | 75.00% | `/system/lib64/platformsdk/libnative_preferences.z.so` |
| `005ad6e14000-005ad6e19000` | .so | `r--p` | 20 | 12 | 0 | 12 | 3 | 60.00% | `/system/lib64/platformsdk/libdatashare_common.z.so` |
| `005adae90000-005adb110000` | native heap | `rw-p` | 2560 | 536 | 257 | 12 | 3 | 0.47% | `[anon:native_heap:jemalloc]` |
| `005adedc8000-005adedcc000` | GL | `r--p` | 16 | 16 | 8 | 12 | 3 | 75.00% | `/system/lib64/platformsdk/libaudio_renderer.z.so` |
| `005adf5c0000-005adff72000` | .so | `r--p` | 9928 | 1976 | 189 | 12 | 3 | 0.12% | `/system/lib64/platformsdk/libace_compatible.z.so` |
...
| `005af8706000-005af8906000` | FilePage other | `rw-p` | 2048 | 44 | 44 | 12 | 3 | 0.59% | `[anon:ffrt_coroutine_stack]` |
| `005af8a54000-005af8b55000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 12 | 3 | 1.17% | `[anon:stack:30011]` |
| `005af957c000-005af967d000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 12 | 3 | 1.17% | `[anon:stack:30023]` |
| `005afb640000-005afb65e000` | .so | `r--p` | 120 | 68 | 3 | 12 | 3 | 10.00% | `/system/lib64/module/net/libhttp.z.so` |
| `005afb937000-005afb93e000` | FilePage other | `rw-p` | 28 | 12 | 12 | 12 | 3 | 42.86% | `[anon:libc++_shared.so.bss]` |
...
| `005affc18000-005affc2f000` | .so | `r-xp` | 92 | 16 | 16 | 12 | 3 | 13.04% | `/data/storage/el1/bundle/libs/arm64/librnoh_gesture_handler.so` |
| `005affe61000-005affe68000` | .so | `r--p` | 28 | 28 | 28 | 12 | 3 | 42.86% | `/data/storage/el1/bundle/libs/arm64/librnoh_reanimated.so` |
| `005b02400000-005b0242d000` | .so | `r--p` | 180 | 132 | 132 | 12 | 3 | 6.67% | `/data/storage/el1/bundle/libs/arm64/libjsi.so` |
...
| `005c4f74e000-005c4f84f000` | FilePage other | `rw-p` | 1028 | 20 | 20 | 12 | 3 | 1.17% | `[anon:stack:30068]` |
| `005d1e882000-005d1e982000` | FilePage other | `rw-p` | 1024 | 80 | 80 | 12 | 3 | 1.17% | `[anon:ffrt_coroutine_stack]` |
| `005d1ea82000-005d1eb82000` | FilePage other | `rw-p` | 1024 | 12 | 12 | 12 | 3 | 1.17% | `[anon:ffrt_coroutine_stack]` |
...
| `005d2688c000-005d2698d000` | FilePage other | `rw-p` | 1028 | 24 | 24 | 12 | 3 | 1.17% | `[anon:stack:30355]` |
...
| `00178ff00000-00178ff40000` | ark ts heap | `r--p` | 256 | 8 | 0 | 8 | 2 | 3.12% | `[anon:ArkTS Heapread only space]` |
| `001e60180000-001e60300000` | ark ts heap | `rw-p` | 1536 | 1304 | 1304 | 8 | 2 | 0.52% | `[anon:ArkTS Heaphuge object space]` |
| `002609580000-0026095c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `002609b40000-002609b80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heap]` |
| `002609ec0000-002609f40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260aa40000-00260aac0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260b140000-00260b1c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260b200000-00260b240000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260b380000-00260b3c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heap]` |
| `00260c480000-00260c500000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260c580000-00260c600000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260e000000-00260e040000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260f440000-00260f480000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heap]` |
| `00260f480000-00260f4c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260f740000-00260f780000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260f840000-00260f880000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260f940000-00260f980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260fb40000-00260fb80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260fc80000-00260fcc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260ff80000-00260ffc0000` | ark ts heap | `rw-p` | 256 | 176 | 63 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared appspawn space]` |
| `003800204000-003800254000` | FilePage other | `rw-p` | 320 | 92 | 92 | 8 | 2 | 2.50% | `[anon:partition_alloc]` |
| `003c00a01000-003c00a03000` | FilePage other | `rw-p` | 8 | 8 | 8 | 8 | 2 | 100.00% | `[anon:partition_alloc]` |
...
| `005a4acd3000-005a4ad0b000` | .so | `r-xp` | 224 | 132 | 8 | 8 | 2 | 3.57% | `/system/lib64/chipset-sdk-sp/libunwinder.z.so` |
| `005a4ad88000-005a4ad98000` | native heap | `rw-p` | 64 | 64 | 3 | 8 | 2 | 12.50% | `[anon:native_heap:brk]` |
| `005a4add0000-005a4adfe000` | FilePage other | `rw-p` | 184 | 132 | 44 | 8 | 2 | 4.35% | `/system/etc/abc/framework/jsEnumStyle.abc` |
...
| `005aceb49000-005acec09000` | .so | `r-xp` | 768 | 512 | 45 | 8 | 2 | 1.04% | `/system/lib64/librosen_text.z.so` |
| `005acec09000-005acec10000` | .so | `r--p` | 28 | 28 | 1 | 8 | 2 | 28.57% | `/system/lib64/librosen_text.z.so` |
...
| `005ad069c000-005ad06a7000` | FilePage other | `rw-p` | 44 | 40 | 4 | 8 | 2 | 18.18% | `[anon:ArkTS Code:/system/lib64/module/libutil.z.so_152960_1]` |
| `005ad1000000-005ad1010000` | .so | `r--p` | 64 | 36 | 0 | 8 | 2 | 12.50% | `/system/lib64/platformsdk/libuv.so` |
| `005ad102f000-005ad1031000` | .so | `r--p` | 8 | 8 | 0 | 8 | 2 | 100.00% | `/system/lib64/platformsdk/libuv.so` |
| `005ad1142000-005ad1168000` | FilePage other | `rw-s` | 152 | 152 | 152 | 8 | 2 | 5.26% | `/data/storage/el2/base/files/log/xlog/DYLog.mmap3` |
| `005ad13ca000-005ad13d5000` | .so | `r-xp` | 44 | 20 | 1 | 8 | 2 | 18.18% | `/system/lib64/chipset-sdk-sp/libdisplay_buffer_hdi_impl_v1_4.z.so` |
| `005ad13d5000-005ad13d7000` | .so | `r--p` | 8 | 8 | 0 | 8 | 2 | 100.00% | `/system/lib64/chipset-sdk-sp/libdisplay_buffer_hdi_impl_v1_4.z.so` |
| `005ad144f000-005ad1451000` | dev | `rw-s` | 8 | 8 | 4 | 8 | 2 | 100.00% | `anon_inode:dev/ashmem/server_client_buffer` |
| `005ad2600000-005ad2646000` | .so | `r--p` | 280 | 112 | 9 | 8 | 2 | 2.86% | `/system/lib64/platformsdk/libmedia_foundation.z.so` |
...
| `005ad788e000-005ad7891000` | .so | `rw-p` | 12 | 12 | 4 | 8 | 2 | 66.67% | `/system/lib64/chipset-sdk-sp/libcrypto_openssl.z.so` |
| `005ad7891000-005ad7894000` | FilePage other | `rw-p` | 12 | 12 | 8 | 8 | 2 | 66.67% | `[anon:libcrypto_openssl.z.so.bss]` |
...
| `005ae466e000-005ae46bc000` | .so | `r-xp` | 312 | 312 | 42 | 8 | 2 | 2.56% | `/system/lib64/platformsdk/libaudio_policy_client.z.so` |
| `005aee381000-005aee383000` | .so | `r-xp` | 8 | 8 | 0 | 8 | 2 | 100.00% | `/system/lib64/libhispeed_string.so` |
| `005af192e000-005af1a2f000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 8 | 2 | 0.78% | `[anon:stack:30004]` |
| `005af8002000-005af8103000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:34508]` |
| `005af8105000-005af8206000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:30008]` |
| `005af8cc7000-005af8dc8000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:30013]` |
| `005af8dca000-005af8ecb000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 8 | 2 | 0.78% | `[anon:stack:30014]` |
| `005af8fd0000-005af90d1000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:30016]` |
| `005af90d3000-005af91d4000` | FilePage other | `rw-p` | 1028 | 24 | 24 | 8 | 2 | 0.78% | `[anon:stack:30018]` |
...
| `005afeae1000-005afebb1000` | .so | `r-xp` | 832 | 224 | 14 | 8 | 2 | 0.96% | `/system/lib64/platformsdk/libnweb_ohos_adapter.z.so` |
| `005affae9000-005affaed000` | GL | `r--p` | 16 | 16 | 16 | 8 | 2 | 50.00% | `/data/storage/el1/bundle/libs/arm64/libreact_render_scheduler.so` |
| `005affc2f000-005affc32000` | .so | `r--p` | 12 | 12 | 12 | 8 | 2 | 66.67% | `/data/storage/el1/bundle/libs/arm64/librnoh_gesture_handler.so` |
| `005affe1e000-005affe61000` | .so | `r-xp` | 268 | 48 | 48 | 8 | 2 | 2.99% | `/data/storage/el1/bundle/libs/arm64/librnoh_reanimated.so` |
| `005b00715000-005b00717000` | .so | `rw-p` | 8 | 8 | 8 | 8 | 2 | 100.00% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `005b02203000-005b02205000` | .so | `r--p` | 8 | 8 | 8 | 8 | 2 | 100.00% | `/system/lib64/ndk/libhitrace_ndk.z.so` |
| `005b0420d000-005b04226000` | .so | `r-xp` | 100 | 88 | 88 | 8 | 2 | 8.00% | `/system/lib64/module/libadvertising.z.so` |
| `005b06fa7000-005b06fa9000` | .so | `r--p` | 8 | 8 | 0 | 8 | 2 | 100.00% | `/system/lib64/module/data/libpreferences.z.so` |
| `005b06fd4000-005b06fd6000` | .so | `r--p` | 8 | 8 | 0 | 8 | 2 | 100.00% | `/system/lib64/libpreferences_jscommon.z.so` |
| `005b078b6000-005b07955000` | .so | `r-xp` | 636 | 492 | 27 | 8 | 2 | 1.26% | `/system/lib64/platformsdk/libcurl_shared_http3.z.so` |
| `005b085e5000-005b08660000` | .so | `r-xp` | 492 | 376 | 41 | 8 | 2 | 1.63% | `/system/lib64/chipset-sdk/libcurl_shared.z.so` |
...
| `005c4da99000-005c4db9a000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 8 | 2 | 0.78% | `[anon:stack:30062]` |
...
| `005c52007000-005c52108000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 8 | 2 | 0.78% | `[anon:stack:30072]` |
| `005c52646000-005c52747000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 8 | 2 | 0.78% | `[anon:stack:30073]` |
| `005c52749000-005c5284a000` | FilePage other | `rw-p` | 1028 | 24 | 24 | 8 | 2 | 0.78% | `[anon:stack:30074]` |
| `005c53cf9000-005c53dfa000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:31122]` |
| `005c551ff000-005c552ff000` | AnonPage other | `rw-p` | 1024 | 28 | 28 | 8 | 2 | 0.78% | `(anonymous)` |
| `005c55400000-005c55814000` | AnonPage other | `rw-p` | 4176 | 92 | 92 | 8 | 2 | 0.19% | `(anonymous)` |
| `005d1ecd6000-005d1ecd8000` | FilePage other | `rw-p` | 8 | 8 | 8 | 8 | 2 | 100.00% | `[anon:libdanmu.so.bss]` |
| `005d1ef95000-005d1f096000` | FilePage other | `rw-p` | 1028 | 24 | 24 | 8 | 2 | 0.78% | `[anon:stack:30234]` |
| `005d1f098000-005d1f199000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:30235]` |
...
| `005d1f971000-005d1fa72000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 8 | 2 | 0.78% | `[anon:stack:30487]` |
| `005d2047d000-005d2057e000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 8 | 2 | 0.78% | `[anon:stack:30277]` |
| `005d20580000-005d20681000` | FilePage other | `rw-p` | 1028 | 20 | 20 | 8 | 2 | 0.78% | `[anon:stack:30278]` |
...
| `005d2618d000-005d2628e000` | FilePage other | `rw-p` | 1028 | 24 | 24 | 8 | 2 | 0.78% | `[anon:stack:30349]` |
| `005d38577000-005d3859f000` | .so | `r--p` | 160 | 160 | 160 | 8 | 2 | 5.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libffmpeg.so` |
...
| `005d3f1cc000-005d3f2cd000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:30423]` |
...
| `005d43efe000-005d43fff000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 8 | 2 | 0.78% | `[anon:stack:30500]` |
| `00178f700000-00178f740000` | ark ts heap | `rw-p` | 256 | 8 | 8 | 4 | 1 | 1.56% | `[anon:ArkTS Heapread only space]` |
| `00178fc80000-00178fcc0000` | ark ts heap | `rw-p` | 256 | 240 | 240 | 4 | 1 | 1.56% | `[anon:ArkTS Heapnon movable space]` |
| `001e60700000-001e60780000` | ark ts heap | `rw-p` | 512 | 456 | 456 | 4 | 1 | 0.78% | `[anon:ArkTS Heaphuge object space]` |
| `002608e80000-002608f00000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `002609240000-002609280000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `0026097c0000-002609800000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260a880000-00260a8c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260a9c0000-00260aa40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260ae00000-00260ae40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260b040000-00260b080000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260b640000-00260b680000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260bb00000-00260bb40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260c000000-00260c040000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260c140000-00260c180000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260c200000-00260c280000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260c280000-00260c300000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260c400000-00260c440000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260cdc0000-00260ce00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260ce40000-00260ce80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d100000-00260d140000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d300000-00260d340000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d400000-00260d440000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d600000-00260d640000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d780000-00260d7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d940000-00260d980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260ddc0000-00260de00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260e800000-00260e840000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260f400000-00260f440000` | ark ts heap | `rw-p` | 256 | 216 | 216 | 4 | 1 | 1.56% | `[anon:ArkTS Heapsemi space]` |
| `00260fac0000-00260fb00000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
...
| `005a49ab5000-005a49ab6000` | dev | `r--s` | 4 | 4 | 0 | 4 | 1 | 100.00% | `/dev/__parameters__/u:object_r:musl_param:s0` |
...
| `005a49ac7000-005a49ad1000` | native heap | `rw-p` | 40 | 40 | 2 | 4 | 1 | 10.00% | `[anon:native_heap:brk]` |
...
| `005a4a084000-005a4a0c0000` | native heap | `rw-p` | 240 | 232 | 17 | 4 | 1 | 1.67% | `[anon:native_heap:brk]` |
...
| `005a4a0df000-005a4a0e1000` | native heap | `rw-p` | 8 | 8 | 8 | 4 | 1 | 50.00% | `[anon:native_heap:brk]` |
| `005a4a180000-005a4a183000` | .so | `r--p` | 12 | 12 | 0 | 4 | 1 | 33.33% | `/system/lib64/chipset-sdk-sp/libasync_stack.z.so` |
...
| `005a4ad9d000-005a4ada9000` | native heap | `rw-p` | 48 | 48 | 17 | 4 | 1 | 8.33% | `[anon:native_heap:brk]` |
| `005a4adc0000-005a4adc5000` | .so | `r--p` | 20 | 16 | 0 | 4 | 1 | 20.00% | `/system/lib64/chipset-sdk-sp/libhitracechain.so` |
...
| `005a4ae21000-005a4ae2c000` | FilePage other | `rw-p` | 44 | 28 | 1 | 4 | 1 | 9.09% | `[anon:ArkTS Code:/system/etc/abc/arkui/arktheme.abc]` |
...
| `005a4ae86000-005a4ae87000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/platformsdk/libhilog.so` |
...
| `005a4aed0000-005a4aed1000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/chipset-sdk-sp/libsec_shared.z.so` |
| `005a4aff7000-005a4aff8000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/ndk/libffrt.so` |
| `005a4b04c000-005a4b065000` | .so | `r-xp` | 100 | 92 | 0 | 4 | 1 | 4.00% | `/system/lib64/chipset-sdk-sp/libbegetutil.z.so` |
...
| `005acbe13000-005acbe2f000` | .so | `r-xp` | 112 | 60 | 0 | 4 | 1 | 3.57% | `/system/lib64/chipset-sdk-sp/libsamgr_proxy.z.so` |
...
| `005acd200000-005acd20e000` | .so | `r--p` | 56 | 16 | 1 | 4 | 1 | 7.14% | `/system/lib64/libhap_restorecon.z.so` |
...
| `005acecd6000-005acecd7000` | FilePage other | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `[anon:libdatashare_consumer.z.so.bss]` |
| `005acee80000-005acee81000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/platformsdk/libappkit_native.z.so` |
| `005acf05a000-005acf076000` | .so | `r-xp` | 112 | 100 | 14 | 4 | 1 | 3.57% | `/system/lib64/platformsdk/libwantagent_innerkits.z.so` |
...
| `005ad03ad000-005ad03bd000` | native heap | `rw-p` | 64 | 64 | 3 | 4 | 1 | 6.25% | `[anon:native_heap:brk]` |
...
| `005ad1400000-005ad1409000` | .so | `r--p` | 36 | 16 | 0 | 4 | 1 | 11.11% | `/system/lib64/chipset-sdk-sp/libbeget_proxy.z.so` |
...
| `005ad6880000-005ad6882000` | .so | `r--p` | 8 | 8 | 0 | 4 | 1 | 50.00% | `/system/lib64/platformsdk/libwsutils.z.so` |
...
| `005ae3f6f000-005ae3f71000` | .so | `rw-p` | 8 | 4 | 4 | 4 | 1 | 50.00% | `/system/lib64/platformsdk/libav_codec_client.z.so` |
...
| `005aee2c4000-005aee2c8000` | .so | `r-xp` | 16 | 16 | 0 | 4 | 1 | 25.00% | `/system/lib64/platformsdk/libhdc_register.z.so` |
...
| `005af1728000-005af1829000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 4 | 1 | 0.39% | `[anon:stack:30002]` |
| `005af8ecd000-005af8fce000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 4 | 1 | 0.39% | `[anon:stack:30015]` |
| `005af91d6000-005af92d7000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 4 | 1 | 0.39% | `[anon:stack:30020]` |
| `005afa478000-005afa59d000` | .so | `r-xp` | 1172 | 964 | 45 | 4 | 1 | 0.34% | `/system/lib64/module/file/libfs.z.so` |
| `005afb6ca000-005afb6cb000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/module/net/libhttp.z.so` |
| `005afb727000-005afb783000` | .so | `r-xp` | 368 | 244 | 244 | 4 | 1 | 1.09% | `/data/storage/el1/bundle/libs/arm64/libmakeurl.so` |
| `005afb800000-005afb891000` | .so | `r--p` | 580 | 324 | 324 | 4 | 1 | 0.69% | `/data/storage/el1/bundle/libs/arm64/libc++_shared.so` |
...
| `005afebb1000-005afebc1000` | .so | `r--p` | 64 | 64 | 64 | 4 | 1 | 6.25% | `/system/lib64/platformsdk/libnweb_ohos_adapter.z.so` |
| `005afec00000-005afec0d000` | .so | `r--p` | 52 | 40 | 15 | 4 | 1 | 7.69% | `/system/lib64/ndk/libnative_drm.so` |
| `005aff8f2000-005aff8f3000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `005aff8f3000-005aff941000` | FilePage other | `rw-p` | 312 | 20 | 20 | 4 | 1 | 1.28% | `[anon:librnoh.so.bss]` |
| `005affa80000-005affab8000` | GL | `r--p` | 224 | 172 | 172 | 4 | 1 | 1.79% | `/data/storage/el1/bundle/libs/arm64/libreact_render_scheduler.so` |
| `005affaee000-005affafe000` | GL | `rw-p` | 64 | 16 | 16 | 4 | 1 | 6.25% | `[anon:libreact_render_scheduler.so.bss]` |
| `005b001c0000-005b002a0000` | .so | `r--p` | 896 | 700 | 700 | 4 | 1 | 0.45% | `/data/storage/el1/bundle/libs/arm64/librnoh_app.so` |
| `005b00324000-005b00325000` | FilePage other | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `[anon:librnoh_app.so.bss]` |
| `005b00717000-005b0071a000` | FilePage other | `rw-p` | 12 | 12 | 12 | 4 | 1 | 33.33% | `[anon:libhermes.so.bss]` |
...
| `005b02461000-005b02464000` | .so | `r--p` | 12 | 12 | 12 | 4 | 1 | 33.33% | `/data/storage/el1/bundle/libs/arm64/libjsi.so` |
| `005b04226000-005b0422b000` | .so | `r--p` | 20 | 20 | 20 | 4 | 1 | 20.00% | `/system/lib64/module/libadvertising.z.so` |
...
| `005b06f80000-005b06f89000` | .so | `r--p` | 36 | 8 | 0 | 4 | 1 | 11.11% | `/system/lib64/module/data/libpreferences.z.so` |
| `005b06fd6000-005b06fd7000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/libpreferences_jscommon.z.so` |
...
| `005b0a005000-005b0a00c000` | .so | `r-xp` | 28 | 16 | 1 | 4 | 1 | 14.29% | `/system/lib64/platformsdk/libsensor_agent.z.so` |
...
| `005c4f240000-005c4f249000` | .so | `r--p` | 36 | 24 | 2 | 4 | 1 | 11.11% | `/system/lib64/libaps_client.z.so` |
...
| `005c4f725000-005c4f727000` | .so | `r--p` | 8 | 8 | 8 | 4 | 1 | 50.00% | `/system/lib64/libframeawaresched.so` |
| `005c4f727000-005c4f728000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/libframeawaresched.so` |
| `005c550fe000-005c551ff000` | FilePage other | `rw-p` | 1028 | 4 | 4 | 4 | 1 | 0.39% | `[anon:stack:30093]` |
| `005d18cce000-005d18cd1000` | .so | `r--p` | 12 | 12 | 12 | 4 | 1 | 33.33% | `/system/lib64/platformsdk/libhttp_client.z.so` |
| `005d18cd1000-005d18cd2000` | .so | `rw-p` | 4 | 4 | 4 | 4 | 1 | 100.00% | `/system/lib64/platformsdk/libhttp_client.z.so` |
| `005d19603000-005d19704000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 4 | 1 | 0.39% | `[anon:stack:30111]` |
...
| `005d1fa74000-005d1fb75000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 4 | 1 | 0.39% | `[anon:stack:30244]` |
| `005d2698d000-005d26a67000` | FilePage other | `r--p` | 872 | 872 | 218 | 4 | 1 | 0.46% | `/data/storage/el2/base/haps/entry/files/rn/bundle/DYRNAnnual2023Q4-harmony_a8cdccc/dyrnannual2023q4.bundle` |
...
| `005d438ec000-005d439ed000` | FilePage other | `rw-p` | 1028 | 4 | 4 | 4 | 1 | 0.39% | `[anon:stack:30491]` |
...
| `002609080000-002609240000` | guard | `---p` | 1792 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `002609540000-002609580000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260a3c0000-00260a480000` | guard | `---p` | 768 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260a480000-00260a4c0000` | ark ts heap | `rw-p` | 256 | 240 | 240 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260a800000-00260a840000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
...
| `00260ab40000-00260ab80000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260abc0000-00260acc0000` | guard | `---p` | 1024 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260acc0000-00260ad00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
| `00260adc0000-00260ae00000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260af80000-00260afc0000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260b000000-00260b040000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260b080000-00260b0c0000` | ark ts heap | `rw-p` | 256 | 24 | 24 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260b340000-00260b380000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260b840000-00260b880000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
...
| `00260bc80000-00260bd00000` | guard | `---p` | 512 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260c340000-00260c3c0000` | guard | `---p` | 512 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260cb40000-00260cc00000` | guard | `---p` | 768 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260d040000-00260d100000` | guard | `---p` | 768 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260d140000-00260d180000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260d280000-00260d300000` | guard | `---p` | 512 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260d480000-00260d4c0000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260d6c0000-00260d780000` | guard | `---p` | 768 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260d7c0000-00260d940000` | guard | `---p` | 1536 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260d980000-00260d9c0000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260d9c0000-00260da00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
...
| `00260de00000-00260de40000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260dfc0000-00260e000000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260e340000-00260e400000` | guard | `---p` | 768 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260e400000-00260e440000` | ark ts heap | `rw-p` | 256 | 96 | 96 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260e440000-00260e480000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260e840000-00260e880000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260ecc0000-00260ed00000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260f580000-00260f5c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
| `00260f6c0000-00260f700000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
...
| `005a4a801000-005a4aa01000` | dev | `r--s` | 2048 | 72 | 3 | 0 | 0 | 0.00% | `/dev/__parameters__/u:object_r:devinfo_public_param:s0` |
...
| `005a4ac3d000-005a4ac40000` | FilePage other | `rw-p` | 12 | 8 | 4 | 0 | 0 | 0.00% | `[anon:ArkTS Code:390359117451]` |
...
| `005a4b037000-005a4b039000` | guard | `---p` | 8 | 0 | 0 | 0 | 0 | 0.00% | `(anonymous)` |
| `005a4b039000-005a4b040000` | FilePage other | `rw-p` | 28 | 0 | 0 | 0 | 0 | 0.00% | `[anon:signal_stack:34508]` |
...
| `005a4b087000-005a4b098000` | .so | `r-xp` | 68 | 68 | 1 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libhisysevent.z.so` |
...
| `005a4b3f3000-005a4b3f4000` | FilePage other | `r--p` | 4 | 4 | 4 | 0 | 0 | 0.00% | `[anon:cfi_shadow:musl]` |
...
| `005acbe7c000-005acbee3000` | GL | `r-xp` | 412 | 352 | 16 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libglobal_resmgr.z.so` |
...
| `005acbf40000-005acbffe000` | .so | `r--p` | 760 | 164 | 5 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libappexecfwk_core.z.so` |
| `005acbffe000-005acc10b000` | .so | `r-xp` | 1076 | 336 | 12 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libappexecfwk_core.z.so` |
...
| `005acc240000-005acc27f000` | .so | `r--p` | 252 | 160 | 3 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwant.z.so` |
| `005acc27f000-005acc2f2000` | .so | `r-xp` | 460 | 244 | 3 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwant.z.so` |
| `005acc2f2000-005acc2f8000` | .so | `r--p` | 24 | 24 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwant.z.so` |
| `005acc2f8000-005acc2f9000` | .so | `rw-p` | 4 | 4 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwant.z.so` |
| `005acc2f9000-005acc2fa000` | FilePage other | `rw-p` | 4 | 4 | 0 | 0 | 0 | 0.00% | `[anon:libwant.z.so.bss]` |
...
| `005acc450000-005acc47a000` | .so | `r-xp` | 168 | 64 | 1 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libaccesstoken_sdk.z.so` |
...
| `005acc486000-005acc490000` | .so | `r-xp` | 40 | 40 | 1 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libucollection_client.z.so` |
...
| `005acc556000-005acc564000` | .so | `r-xp` | 56 | 44 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcesfwk_innerkits.z.so` |
| `005acc564000-005acc566000` | .so | `r--p` | 8 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcesfwk_innerkits.z.so` |
...
| `005acc6c0000-005acc6d8000` | .so | `r--p` | 96 | 28 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcesfwk_core.z.so` |
| `005acc6d8000-005acc6f0000` | .so | `r-xp` | 96 | 76 | 1 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcesfwk_core.z.so` |
| `005acc6f0000-005acc6f6000` | .so | `r--p` | 24 | 24 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcesfwk_core.z.so` |
...
| `005acc780000-005acc78c000` | .so | `r--p` | 48 | 36 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libbase.z.so` |
| `005acc78c000-005acc794000` | .so | `r-xp` | 32 | 24 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libbase.z.so` |
| `005acc794000-005acc798000` | .so | `r--p` | 16 | 16 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libbase.z.so` |
...
| `005acc7d0000-005acc7f8000` | .so | `r-xp` | 160 | 112 | 4 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libressched_client.z.so` |
...
| `005accac6000-005accad9000` | .so | `r-xp` | 76 | 44 | 2 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libstring_utils.z.so` |
...
| `005accb88000-005accb9a000` | .so | `r-xp` | 72 | 32 | 2 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaccountkits.z.so` |
...
| `005accbc0000-005accc89000` | .so | `r--p` | 804 | 320 | 24 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhmicuuc.z.so` |
| `005accc89000-005accda3000` | .so | `r-xp` | 1128 | 468 | 22 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhmicuuc.z.so` |
...
| `005accec0000-005accf1c000` | .so | `r--p` | 368 | 84 | 5 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhmicui18n.z.so` |
| `005accf1c000-005acd05d000` | .so | `r-xp` | 1284 | 444 | 44 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhmicui18n.z.so` |
...
| `005acd0c0000-005acd0d3000` | .so | `r--p` | 76 | 36 | 1 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libjsoncpp.z.so` |
| `005acd0d3000-005acd0f5000` | .so | `r-xp` | 136 | 116 | 4 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libjsoncpp.z.so` |
...
| `005acdf82000-005acdf87000` | .so | `r-xp` | 20 | 16 | 1 | 0 | 0 | 0.00% | `/system/lib64/libhisysevent_report.z.so` |
...
| `005acf580000-005acf918000` | GL | `r--p` | 3680 | 856 | 40 | 0 | 0 | 0.00% | `/system/lib64/librender_service_base.z.so` |
...
| `005acff93000-005acffb4000` | .so | `r-xp` | 132 | 48 | 6 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libpluginmanager.z.so` |
...
| `005ad0640000-005ad0659000` | .so | `r--p` | 100 | 100 | 14 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libexif.z.so` |
...
| `005ad1654000-005ad166c000` | .so | `r-xp` | 96 | 52 | 10 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaccessibilityconfig.z.so` |
...
| `005ad2700000-005ad278f000` | .so | `r--p` | 572 | 204 | 16 | 0 | 0 | 0.00% | `/system/lib64/libstd.dylib.so` |
...
| `005ad2b09000-005ad2b17000` | .so | `r-xp` | 56 | 28 | 2 | 0 | 0 | 0.00% | `/system/lib64/libpurgeablemem_plugin.z.so` |
...
| `005ad2e06000-005ad2e18000` | .so | `r-xp` | 72 | 60 | 4 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libhdi_base.z.so` |
...
| `005ad3ac0000-005ad4968000` | .so | `r--p` | 15008 | 540 | 49 | 0 | 0 | 0.00% | `/system/lib64/libskia_canvaskit.z.so` |
| `005ad4968000-005ad5714000` | .so | `r-xp` | 14000 | 2624 | 490 | 0 | 0 | 0.00% | `/system/lib64/libskia_canvaskit.z.so` |
...
| `005ad5a48000-005ad5a51000` | .so | `r-xp` | 36 | 36 | 4 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwantagent_manager.z.so` |
...
| `005ad5d40000-005ad5dab000` | .so | `r--p` | 428 | 184 | 10 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libimage_native.z.so` |
| `005ad5dab000-005ad5e90000` | .so | `r-xp` | 916 | 464 | 52 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libimage_native.z.so` |
...
| `005ad6bed000-005ad6d41000` | .so | `r-xp` | 1360 | 884 | 20 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libsqlite.z.so` |
...
| `005ad7c40000-005ad7c7e000` | .so | `r--p` | 248 | 40 | 5 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libimage_accessor.z.so` |
| `005ad7c7e000-005ad7d50000` | .so | `r-xp` | 840 | 232 | 46 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libimage_accessor.z.so` |
...
| `005ad7e05000-005ad7e96000` | .so | `r-xp` | 580 | 224 | 5 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libapp_manager.z.so` |
...
| `005ad8206000-005ad8214000` | .so | `r-xp` | 56 | 36 | 2 | 0 | 0 | 0.00% | `/system/lib64/librelational_common_base.z.so` |
...
| `005ad82c0000-005ad8452000` | .so | `r--p` | 1608 | 36 | 2 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libohosffmpeg.z.so` |
...
| `005ad9d28000-005ad9d7c000` | .so | `r-xp` | 336 | 308 | 16 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhiappevent_base.z.so` |
...
| `005ad9f92000-005ada092000` | .so | `r-xp` | 1024 | 752 | 21 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnative_rdb.z.so` |
...
| `005adac42000-005adac5f000` | .so | `r-xp` | 116 | 112 | 27 | 0 | 0 | 0.00% | `/system/lib64/libhispeed_image.so` |
...
| `005adb801000-005add682000` | FilePage other | `r--s` | 31236 | 568 | 84 | 0 | 0 | 0.00% | `/system/usr/icu/icudt74l.dat` |
...
| `005add6c0000-005add6d0000` | .so | `r--p` | 64 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_haptic.z.so` |
...
| `005add7c0000-005add814000` | .so | `r--p` | 336 | 192 | 20 | 0 | 0 | 0.00% | `/system/lib64/libaudio_framework_interface.z.so` |
| `005add814000-005add905000` | .so | `r-xp` | 964 | 436 | 134 | 0 | 0 | 0.00% | `/system/lib64/libaudio_framework_interface.z.so` |
...
| `005adda80000-005addaab000` | .so | `r--p` | 172 | 120 | 21 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_client.z.so` |
| `005addaab000-005addac2000` | .so | `r-xp` | 92 | 92 | 14 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_client.z.so` |
...
| `005addb00000-005addb07000` | .so | `r--p` | 28 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libfmskit_provider_client.z.so` |
...
| `005addb80000-005adddfe000` | .so | `r--p` | 2552 | 128 | 20 | 0 | 0 | 0.00% | `/system/lib64/libarkruntime.so` |
...
| `005ade680000-005ade6a8000` | .so | `r--p` | 160 | 72 | 10 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_policy_manager.z.so` |
| `005ade6a8000-005ade6c6000` | .so | `r-xp` | 120 | 88 | 13 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_policy_manager.z.so` |
...
| `005ade7c0000-005ade7f3000` | .so | `r--p` | 204 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/lib3dWidgetAdapter.z.so` |
...
| `005adeb80000-005adeb8a000` | .so | `r--p` | 40 | 12 | 0 | 0 | 0 | 0.00% | `/system/lib64/libpasteboard_framework.z.so` |
...
| `005adeec0000-005adeef8000` | .so | `r--p` | 224 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libdrawing_napi_impl.z.so` |
...
| `005ae34c0000-005ae34c7000` | .so | `r--p` | 28 | 28 | 1 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libmedia_monitor_client.z.so` |
| `005ae34c7000-005ae34d5000` | .so | `r-xp` | 56 | 56 | 11 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libmedia_monitor_client.z.so` |
...
| `005ae3b40000-005ae3b49000` | .so | `r--p` | 36 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libdata_ability_helper.z.so` |
...
| `005ae3d0a000-005ae3d1a000` | .so | `r-xp` | 64 | 40 | 8 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_foundation.z.so` |
...
| `005ae3da4000-005ae3e0e000` | .so | `r-xp` | 424 | 120 | 11 | 0 | 0 | 0.00% | `/system/lib64/libaudio_policy_client_idl_interface.z.so` |
...
| `005ae3f80000-005ae3fa0000` | .so | `r--p` | 128 | 72 | 10 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_utils.z.so` |
...
| `005ae42c0000-005ae42c8000` | .so | `r--p` | 32 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libauto_fill_manager.z.so` |
...
| `005ae4345000-005ae434c000` | .so | `r-xp` | 28 | 28 | 4 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libmedia_monitor_common.z.so` |
...
| `005ae4640000-005ae466e000` | .so | `r--p` | 184 | 124 | 12 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_policy_client.z.so` |
...
| `005ae4740000-005ae47cf000` | .so | `r--p` | 572 | 208 | 57 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libscene_session_manager.z.so` |
...
| `005ae49c0000-005ae4a81000` | .so | `r--p` | 772 | 36 | 4 | 0 | 0 | 0.00% | `/system/lib64/libarktscompiler.so` |
...
| `005aec440000-005aec45b000` | .so | `r--p` | 108 | 56 | 2 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnet_conn_manager_if.z.so` |
...
| `005aecd00000-005aecd9d000` | .so | `r--p` | 628 | 216 | 25 | 0 | 0 | 0.00% | `/system/lib64/libans_innerkits.z.so` |
...
| `005aed5c0000-005aed5d4000` | .so | `r--p` | 80 | 16 | 2 | 0 | 0 | 0.00% | `/system/lib64/libdevice_cert_mgr_sdk.z.so` |
...
| `005aedb0c000-005aedb17000` | .so | `r-xp` | 44 | 44 | 3 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnapi_utils.z.so` |
...
| `005af182b000-005af192c000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 0 | 0 | 0.00% | `[anon:stack:30003]` |
...
| `005af8000000-005af8002000` | guard | `---p` | 8 | 0 | 0 | 0 | 0 | 0.00% | `[anon:guard:34508]` |
...
| `005afbbcc000-005afbc01000` | .so | `r-xp` | 212 | 76 | 7 | 0 | 0 | 0.00% | `/system/lib64/module/libpromptaction.z.so` |
...
| `005afbf80000-005afbf90000` | .so | `r--p` | 64 | 48 | 3 | 0 | 0 | 0.00% | `/system/lib64/liblocator_interface_proxy.z.so` |
| `005afbf90000-005afbfb6000` | .so | `r-xp` | 152 | 28 | 2 | 0 | 0 | 0.00% | `/system/lib64/liblocator_interface_proxy.z.so` |
...
| `005afbfc0000-005afbfe3000` | .so | `r--p` | 140 | 80 | 28 | 0 | 0 | 0.00% | `/system/lib64/module/libgeolocationmanager.z.so` |
| `005afbfe3000-005afc04f000` | .so | `r-xp` | 432 | 100 | 35 | 0 | 0 | 0.00% | `/system/lib64/module/libgeolocationmanager.z.so` |
...
| `005afc0a2000-005afc0df000` | .so | `r-xp` | 244 | 80 | 8 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/liblbsservice_common.z.so` |
...
| `005afc100000-005afc114000` | .so | `r--p` | 80 | 52 | 5 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/liblocator_sdk.z.so` |
...
| `005afc1c0000-005afc1f4000` | .so | `r--p` | 208 | 156 | 9 | 0 | 0 | 0.00% | `/system/lib64/libconnection_if.z.so` |
| `005afc1f4000-005afc226000` | .so | `r-xp` | 200 | 96 | 7 | 0 | 0 | 0.00% | `/system/lib64/libconnection_if.z.so` |
...
| `005afc280000-005afc28f000` | .so | `r--p` | 60 | 44 | 3 | 0 | 0 | 0.00% | `/system/lib64/module/net/libconnection.z.so` |
...
| `005afc2c0000-005afc2e6000` | .so | `r--p` | 152 | 72 | 5 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwifi_sdk.z.so` |
...
| `005afc380000-005afc390000` | .so | `r--p` | 64 | 64 | 4 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwifi_utils.z.so` |
| `005afc390000-005afc3b9000` | .so | `r-xp` | 164 | 24 | 2 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwifi_utils.z.so` |
...
| `005afc3cc000-005afc3fb000` | .so | `r-xp` | 188 | 76 | 11 | 0 | 0 | 0.00% | `/system/lib64/module/libwifimanager.z.so` |
...
| `005afcd40000-005afcd50000` | .so | `r--p` | 64 | 32 | 2 | 0 | 0 | 0.00% | `/system/lib64/libha_app_event.z.so` |
| `005afcd50000-005afcd8e000` | .so | `r-xp` | 248 | 164 | 11 | 0 | 0 | 0.00% | `/system/lib64/libha_app_event.z.so` |
...
| `005afe7d4000-005afe7ea000` | .so | `r-xp` | 88 | 64 | 7 | 0 | 0 | 0.00% | `/system/lib64/module/app/ability/libappmanager.z.so` |
...
| `005b037c0000-005b037cc000` | .so | `r--p` | 48 | 32 | 4 | 0 | 0 | 0.00% | `/system/lib64/module/libaccessibility_napi.z.so` |
| `005b037cc000-005b037eb000` | .so | `r-xp` | 124 | 60 | 8 | 0 | 0 | 0.00% | `/system/lib64/module/libaccessibility_napi.z.so` |
...
| `005b03800000-005b03814000` | .so | `r--p` | 80 | 72 | 23 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libtel_call_manager_api.z.so` |
| `005b03814000-005b03849000` | .so | `r-xp` | 212 | 80 | 12 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libtel_call_manager_api.z.so` |
...
| `005b03880000-005b0388c000` | .so | `r--p` | 48 | 40 | 20 | 0 | 0 | 0.00% | `/system/lib64/module/telephony/libcall.z.so` |
| `005b0388c000-005b038bb000` | .so | `r-xp` | 188 | 68 | 30 | 0 | 0 | 0.00% | `/system/lib64/module/telephony/libcall.z.so` |
| `005b038bb000-005b038bf000` | .so | `r--p` | 16 | 16 | 16 | 0 | 0 | 0.00% | `/system/lib64/module/telephony/libcall.z.so` |
| `005b038bf000-005b038c4000` | .so | `rw-p` | 20 | 16 | 6 | 0 | 0 | 0.00% | `/system/lib64/module/telephony/libcall.z.so` |
...
| `005b05401000-005b05404000` | .so | `r-xp` | 12 | 8 | 0 | 0 | 0 | 0.00% | `/system/lib64/ndk/libhilog_ndk.z.so` |
| `005b05404000-005b05405000` | .so | `r--p` | 4 | 4 | 0 | 0 | 0 | 0.00% | `/system/lib64/ndk/libhilog_ndk.z.so` |
...
| `005b0738d000-005b073b2000` | .so | `r-xp` | 148 | 92 | 16 | 0 | 0 | 0.00% | `/system/lib64/module/hiviewdfx/libhiappevent_napi.z.so` |
...
| `005b07780000-005b0778c000` | .so | `r--p` | 48 | 8 | 1 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libopenhitls_pki.z.so` |
...
| `005b07800000-005b0780b000` | .so | `r--p` | 44 | 8 | 1 | 0 | 0 | 0.00% | `/system/lib64/librcp_network_listener.z.so` |
...
| `005b07880000-005b078b6000` | .so | `r--p` | 216 | 100 | 8 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcurl_shared_http3.z.so` |
...
| `005b07a40000-005b07aae000` | .so | `r--p` | 440 | 132 | 10 | 0 | 0 | 0.00% | `/system/lib64/libcollaboration_rcp_native.z.so` |
| `005b07aae000-005b07b1b000` | .so | `r-xp` | 436 | 68 | 3 | 0 | 0 | 0.00% | `/system/lib64/libcollaboration_rcp_native.z.so` |
...
| `005b07b40000-005b07b4f000` | .so | `r--p` | 60 | 32 | 3 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libnghttp2_shared.z.so` |
...
| `005b07b80000-005b07bde000` | .so | `r--p` | 376 | 16 | 2 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libopenhitls_crypto.z.so` |
...
| `005b07f40000-005b07f47000` | .so | `r--p` | 28 | 28 | 4 | 0 | 0 | 0.00% | `/system/lib64/libha_client.z.so` |
...
| `005b09ed1000-005b09f0f000` | .so | `r-xp` | 248 | 72 | 7 | 0 | 0 | 0.00% | `/system/lib64/module/security/libcryptoframework_napi.z.so` |
...
| `005b0a200000-005b0a210000` | .so | `r--p` | 64 | 16 | 2 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libtel_common.z.so` |
...
| `005d18c80000-005d18c9f000` | .so | `r--p` | 124 | 96 | 6 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhttp_client.z.so` |
...
| `005d2d180000-005d2d189000` | .so | `r--p` | 36 | 24 | 2 | 0 | 0 | 0.00% | `/system/lib64/ndk/libohcommonevent.so` |
| `005d2d189000-005d2d193000` | .so | `r-xp` | 40 | 24 | 1 | 0 | 0 | 0.00% | `/system/lib64/ndk/libohcommonevent.so` |
| `005d2d193000-005d2d194000` | .so | `r--p` | 4 | 4 | 4 | 0 | 0 | 0.00% | `/system/lib64/ndk/libohcommonevent.so` |
...
| `005d38740000-005d38754000` | .so | `r--p` | 80 | 52 | 5 | 0 | 0 | 0.00% | `/system/lib64/ndk/libohinput.so` |
...
| `005d437ea000-005d438ea000` | FilePage other | `rw-p` | 1024 | 80 | 80 | 0 | 0 | 0.00% | `[anon:ffrt_coroutine_stack]` |
