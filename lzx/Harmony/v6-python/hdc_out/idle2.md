...
| 采样时间 | `2026-05-31 19:57:44` |
| VMA 数 | `6514` |
| Size | `48586976 KiB` |
| Rss | `628152 KiB` |
| Pss | `463291 KiB` |
| Referenced | `51132 KiB / 12783 页` |
| Swap | `56988 KiB` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| ark ts heap | 331 | 103936 | 98212 | 92360 | 9980 | 88 | 9.60% | 10.16% |
| native heap | 164 | 393656 | 244776 | 235384 | 26756 | 32916 | 6.80% | 10.93% |
| AnonPage other | 11 | 1590028 | 11172 | 11172 | 612 | 8 | 0.04% | 5.48% |
| FilePage other | 1368 | 706204 | 39280 | 31012 | 2600 | 3968 | 0.37% | 6.62% |
| stack | 2 | 8184 | 100 | 100 | 36 | 0 | 0.44% | 36.00% |
| .so | 3749 | 709736 | 188592 | 65756 | 10136 | 14840 | 1.43% | 5.37% |
| .hap | 23 | 178448 | 8348 | 8229 | 196 | 0 | 0.11% | 2.35% |
| .ttf | 6 | 67444 | 10976 | 1838 | 0 | 0 | 0.00% | 0.00% |
| dev | 230 | 41100 | 14140 | 13466 | 96 | 0 | 0.23% | 0.68% |
| GL | 177 | 71716 | 10764 | 3772 | 512 | 5012 | 0.71% | 4.76% |
| Graph | 44 | 5864 | 1772 | 190 | 208 | 132 | 3.55% | 11.74% |
| guard | 409 | 44710660 | 20 | 12 | 0 | 24 | 0.00% | 0.00% |

## Referenced VMA 定位

| VMA | 一级段 | 权限 | Size(KiB) | Rss(KiB) | Pss(KiB) | Referenced(KiB) | Referenced页 | Referenced/Size | 路径 |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `005d24388000-005d24b88000` | native heap | `rw-p` | 8192 | 7724 | 7724 | 7220 | 1805 | 88.13% | `[anon:native_heap:jemalloc]` |
| `005d25585000-005d25f85000` | native heap | `rw-p` | 10240 | 6312 | 6312 | 3156 | 789 | 30.82% | `[anon:native_heap:jemalloc]` |
| `005c542f9000-005c54ff9000` | native heap | `rw-p` | 13312 | 9000 | 9000 | 2612 | 653 | 19.62% | `[anon:native_heap:jemalloc]` |
| `005d1c67f000-005d1e27f000` | native heap | `rw-p` | 28672 | 26996 | 26996 | 2064 | 516 | 7.20% | `[anon:native_heap:jemalloc]` |
| `005afa5d2000-005afb5d2000` | native heap | `rw-p` | 16384 | 13076 | 13076 | 1976 | 494 | 12.06% | `[anon:native_heap:jemalloc]` |
| `005ad3111000-005ad38ba000` | .so | `r-xp` | 7844 | 5052 | 228 | 1936 | 484 | 24.68% | `/system/lib64/platformsdk/libark_jsruntime.so` |
| `005ae8849000-005aeb449000` | native heap | `rw-p` | 45056 | 16108 | 12577 | 1536 | 384 | 3.41% | `[anon:native_heap:jemalloc]` |
| `005d2208a000-005d2408a000` | native heap | `rw-p` | 32768 | 26816 | 26816 | 1424 | 356 | 4.35% | `[anon:native_heap:jemalloc]` |
| `005ae8180000-005ae83d8000` | .so | `r-xp` | 2400 | 1688 | 617 | 1236 | 309 | 51.50% | `/vendor/lib64/passthrough/libhvgr_v210.so` |
| `005d17436000-005d18c36000` | native heap | `rw-p` | 24576 | 23964 | 23964 | 1172 | 293 | 4.77% | `[anon:native_heap:jemalloc]` |
| `005c50052000-005c51452000` | native heap | `rw-p` | 20480 | 19780 | 19780 | 1060 | 265 | 5.18% | `[anon:native_heap:jemalloc]` |
| `005afd869000-005afe0dd000` | .so | `r-xp` | 8656 | 3188 | 3188 | 1016 | 254 | 11.74% | `/data/storage/el1/bundle/libs/arm64/libdyplayer.so` |
| `005a49c01000-005a49e00000` | native heap | `rw-p` | 2044 | 1580 | 1568 | 880 | 220 | 43.05% | `[anon:native_heap:jemalloc meta]` |
| `005d26d8e000-005d2958e000` | native heap | `rw-p` | 40960 | 39488 | 39488 | 692 | 173 | 1.69% | `[anon:native_heap:jemalloc]` |
| `005a4962c000-005a497a2000` | FilePage other | `r-xp` | 1496 | 1264 | 9 | 668 | 167 | 44.65% | `/system/lib/ld-musl-aarch64.so.1` |
| `005aeeb0b000-005aef92f000` | FilePage other | `r-xp` | 14480 | 1276 | 62 | 668 | 167 | 4.61% | `/system/lib64/module/arkcompiler/stub.an` |
| `005d29e6a000-005d2ce6a000` | native heap | `rw-p` | 49152 | 33888 | 33888 | 648 | 162 | 1.32% | `[anon:native_heap:jemalloc]` |
| `005c55c15000-005c56014000` | AnonPage other | `rw-p` | 4092 | 4092 | 4092 | 532 | 133 | 13.00% | `(anonymous)` |
| `00260ed80000-00260ee00000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 512 | 128 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `005b00537000-005b0070b000` | .so | `r-xp` | 1872 | 1544 | 1544 | 428 | 107 | 22.86% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `005aee704000-005aee904000` | native heap | `rw-p` | 2048 | 1876 | 1818 | 400 | 100 | 19.53% | `[anon:native_heap:jemalloc]` |
| `005c521c4000-005c52544000` | native heap | `rw-p` | 3584 | 3060 | 3060 | 372 | 93 | 10.38% | `[anon:native_heap:jemalloc]` |
| `005a4a201000-005a4a600000` | native heap | `rw-p` | 4092 | 636 | 632 | 340 | 85 | 8.31% | `[anon:native_heap:jemalloc meta]` |
| `005a4af69000-005a4aff2000` | .so | `r-xp` | 548 | 520 | 4 | 312 | 78 | 56.93% | `/system/lib64/ndk/libffrt.so` |
| `005d18e01000-005d19600000` | native heap | `rw-p` | 8188 | 432 | 432 | 276 | 69 | 3.37% | `[anon:native_heap:jemalloc meta]` |
| `0026093c0000-002609400000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `002609500000-002609540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `00260b740000-00260b780000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `00260cbc0000-00260cc00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `00260dc80000-00260dcc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `00260e740000-00260e780000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 256 | 64 | 100.00% | `[anon:ArkTS Heapsemi space]` |
| `002609940000-002609980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 252 | 63 | 98.44% | `[anon:ArkTS Heapsemi space]` |
| `005aee401000-005aee600000` | native heap | `rw-p` | 2044 | 332 | 316 | 248 | 62 | 12.13% | `[anon:native_heap:jemalloc meta]` |
| `005d1ec46000-005d1eccf000` | .so | `r-xp` | 548 | 548 | 548 | 240 | 60 | 43.80% | `/data/storage/el1/bundle/libs/arm64/libdanmu.so` |
| `005ad0f80000-005ad0fdd000` | .so | `r-xp` | 372 | 332 | 9 | 236 | 59 | 63.44% | `/system/lib64/platformsdk/libace_napi.z.so` |
| `00260dcc0000-00260dd80000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 232 | 58 | 30.21% | `[anon:ArkTS Heap]` |
| `001e60400000-001e60480000` | ark ts heap | `rw-p` | 512 | 452 | 452 | 228 | 57 | 44.53% | `[anon:ArkTS Heaphuge object space]` |
| `00260b440000-00260b540000` | ark ts heap | `rw-p` | 1024 | 964 | 964 | 220 | 55 | 21.48% | `[anon:ArkTS Heap]` |
| `005a4ab10000-005a4abae000` | .so | `r-xp` | 632 | 416 | 4 | 200 | 50 | 31.65% | `/system/lib64/chipset-sdk-sp/libc++.so` |
| `005b4d432000-005b4dc7e000` | .hap | `r--p` | 8496 | 7536 | 7533 | 196 | 49 | 2.31% | `/data/storage/el1/bundle/entry.hap` |
| `005acc36f000-005acc3c1000` | GL | `r-xp` | 328 | 208 | 1 | 188 | 47 | 57.32% | `/system/lib64/platformsdk/libipc_single.z.so` |
| `005adb201000-005adb800000` | native heap | `rw-p` | 6140 | 248 | 193 | 188 | 47 | 3.06% | `[anon:native_heap:jemalloc meta]` |
| `005ae7f80000-005ae7ff4000` | .so | `r--p` | 464 | 264 | 87 | 176 | 44 | 37.93% | `/vendor/lib64/passthrough/libhvgr_v210.so` |
| `005afd580000-005afd868000` | .so | `r--p` | 2976 | 1608 | 1608 | 168 | 42 | 5.65% | `/data/storage/el1/bundle/libs/arm64/libdyplayer.so` |
| `005aff6b5000-005aff8d4000` | .so | `r-xp` | 2172 | 512 | 512 | 164 | 41 | 7.55% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `005c4db9a000-005c4de1a000` | native heap | `rw-p` | 2560 | 1764 | 1764 | 164 | 41 | 6.41% | `[anon:native_heap:jemalloc]` |
| `00260bf00000-00260bf40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 156 | 39 | 60.94% | `[anon:ArkTS Heap]` |
| `005ad2f00000-005ad3111000` | .so | `r--p` | 2116 | 612 | 30 | 156 | 39 | 7.37% | `/system/lib64/platformsdk/libark_jsruntime.so` |
| `002609240000-002609280000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 152 | 38 | 59.38% | `[anon:ArkTS Heapshared old space]` |
| `005acce14000-005acce41000` | .so | `r-xp` | 180 | 164 | 2 | 152 | 38 | 84.44% | `/system/lib64/chipset-sdk-sp/libeventhandler.z.so` |
| `005c4e71d000-005c4ea1d000` | native heap | `rw-p` | 3072 | 2960 | 2960 | 152 | 38 | 4.95% | `[anon:native_heap:jemalloc]` |
| `00260d400000-00260d440000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 144 | 36 | 56.25% | `[anon:ArkTS Heapshared old space]` |
| `00260f380000-00260f3c0000` | ark ts heap | `rw-p` | 256 | 256 | 57 | 144 | 36 | 56.25% | `[anon:ArkTS Heapappspawn space]` |
| `00260b240000-00260b2c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 140 | 35 | 27.34% | `[anon:ArkTS Heapshared old space]` |
| `00260c200000-00260c280000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 140 | 35 | 27.34% | `[anon:ArkTS Heapshared old space]` |
| `005ace8b3000-005ace905000` | Graph | `r-xp` | 328 | 260 | 13 | 132 | 33 | 40.24% | `/system/lib64/chipset-sdk-sp/libsurface.z.so` |
| `005c4f4e7000-005c4f5e7000` | FilePage other | `rw-p` | 1024 | 1024 | 1024 | 128 | 32 | 12.50% | `[anon:async_stack_table]` |
| `00260b880000-00260b8c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 120 | 30 | 46.88% | `[anon:ArkTS Heap]` |
| `00178fe80000-00178fec0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 116 | 29 | 45.31% | `[anon:ArkTS Heapnon movable space]` |
| `001e60080000-001e60100000` | ark ts heap | `rw-p` | 512 | 456 | 456 | 116 | 29 | 22.66% | `[anon:ArkTS Heapshared huge object space]` |
| `002609ec0000-002609f40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 116 | 29 | 22.66% | `[anon:ArkTS Heapshared old space]` |
| `005a49e01000-005a4a001000` | native heap | `rw-p` | 2048 | 788 | 363 | 116 | 29 | 5.66% | `[anon:native_heap:jemalloc]` |
| `005afe0dd000-005afe14b000` | .so | `r--p` | 440 | 440 | 440 | 116 | 29 | 26.36% | `/data/storage/el1/bundle/libs/arm64/libdyplayer.so` |
| `00260fb00000-00260fb40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 108 | 27 | 42.19% | `[anon:ArkTS Heap]` |
| `005ae3ea7000-005ae3f62000` | .so | `r-xp` | 748 | 180 | 28 | 108 | 27 | 14.44% | `/system/lib64/platformsdk/libav_codec_client.z.so` |
| `00260f780000-00260f7c0000` | ark ts heap | `rw-p` | 256 | 148 | 97 | 104 | 26 | 40.62% | `[anon:ArkTS Heapshared appspawn space]` |
| `00260c440000-00260c480000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 96 | 24 | 37.50% | `[anon:ArkTS Heap]` |
| `005afe152000-005afe44b000` | FilePage other | `rw-p` | 3044 | 276 | 276 | 96 | 24 | 3.15% | `[anon:libdyplayer.so.bss]` |
| `00260cd40000-00260cd80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 92 | 23 | 35.94% | `[anon:ArkTS Heapshared old space]` |
| `00260fa80000-00260fac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 92 | 23 | 35.94% | `[anon:ArkTS Heap]` |
| `00260f3c0000-00260f400000` | ark ts heap | `rw-p` | 256 | 256 | 53 | 88 | 22 | 34.38% | `[anon:ArkTS Heapappspawn space]` |
| `005a4ad52000-005a4ad83000` | .so | `r-xp` | 196 | 100 | 0 | 88 | 22 | 44.90% | `/system/lib64/libhilog_inner.so` |
| `005ada666000-005ada68c000` | GL | `r-xp` | 152 | 152 | 11 | 88 | 22 | 57.89% | `/system/lib64/libEGL.so` |
| `002608d40000-002608dc0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 84 | 21 | 16.41% | `[anon:ArkTS Heap]` |
| `002609600000-002609640000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 84 | 21 | 32.81% | `[anon:ArkTS Heapshared old space]` |
| `00260a580000-00260a5c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 84 | 21 | 32.81% | `[anon:ArkTS Heapshared old space]` |
| `00260f580000-00260f5c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 84 | 21 | 32.81% | `[anon:ArkTS Heapshared old space]` |
| `00260fc40000-00260fc80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 84 | 21 | 32.81% | `[anon:ArkTS Heapshared old space]` |
...
| `005afb891000-005afb92b000` | .so | `r-xp` | 616 | 248 | 248 | 84 | 21 | 13.64% | `/data/storage/el1/bundle/libs/arm64/libc++_shared.so` |
| `00260ab40000-00260abc0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 80 | 20 | 15.62% | `[anon:ArkTS Heapsemi space]` |
| `005ad1010000-005ad102f000` | .so | `r-xp` | 124 | 124 | 3 | 80 | 20 | 64.52% | `/system/lib64/platformsdk/libuv.so` |
| `005ae3638000-005ae368e000` | .so | `r-xp` | 344 | 116 | 20 | 80 | 20 | 23.26% | `/system/lib64/platformsdk/libaudio_common.z.so` |
| `00260be40000-00260be80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 76 | 19 | 29.69% | `[anon:ArkTS Heapshared old space]` |
| `005adb187000-005adb1fe000` | FilePage other | `rw-p` | 476 | 352 | 26 | 76 | 19 | 15.97% | `/system/etc/abc/framework/stateMgmt.abc` |
| `00178f5c0000-00178f600000` | ark ts heap | `rw-p` | 256 | 180 | 180 | 72 | 18 | 28.12% | `[anon:ArkTS Heapnon movable space]` |
| `00178ffc0000-001790000000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 72 | 18 | 28.12% | `[anon:ArkTS Heapnon movable space]` |
| `00260b2c0000-00260b340000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 72 | 18 | 14.06% | `[anon:ArkTS Heapshared old space]` |
| `00260e280000-00260e2c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 72 | 18 | 28.12% | `[anon:ArkTS Heapsemi space]` |
| `00260a200000-00260a240000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 68 | 17 | 26.56% | `[anon:ArkTS Heapshared old space]` |
| `00260d1c0000-00260d200000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 68 | 17 | 26.56% | `[anon:ArkTS Heapshared old space]` |
| `00260eb00000-00260eb80000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 68 | 17 | 13.28% | `[anon:ArkTS Heapsemi space]` |
| `00260f200000-00260f240000` | ark ts heap | `rw-p` | 256 | 256 | 53 | 68 | 17 | 26.56% | `[anon:ArkTS Heapappspawn space]` |
| `00260f600000-00260f640000` | ark ts heap | `rw-p` | 256 | 256 | 119 | 68 | 17 | 26.56% | `[anon:ArkTS Heapshared appspawn space]` |
| `005aff8d4000-005aff8f2000` | .so | `r--p` | 120 | 120 | 120 | 68 | 17 | 56.67% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `00260a380000-00260a3c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 64 | 16 | 25.00% | `[anon:ArkTS Heap]` |
| `00260fd80000-00260fdc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 64 | 16 | 25.00% | `[anon:ArkTS Heapshared old space]` |
| `005ad6dd9000-005ad6e14000` | .so | `r-xp` | 236 | 76 | 2 | 64 | 16 | 27.12% | `/system/lib64/platformsdk/libdatashare_common.z.so` |
| `00260c700000-00260c780000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 60 | 15 | 11.72% | `[anon:ArkTS Heapshared old space]` |
| `00260d600000-00260d680000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 60 | 15 | 11.72% | `[anon:ArkTS Heapshared old space]` |
| `00260f540000-00260f580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 60 | 15 | 23.44% | `[anon:ArkTS Heapshared old space]` |
| `00260f800000-00260f840000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 60 | 15 | 23.44% | `[anon:ArkTS Heap]` |
| `005a4ac17000-005a4ac36000` | .so | `r-xp` | 124 | 112 | 0 | 60 | 15 | 48.39% | `/system/lib64/chipset-sdk-sp/libutils.z.so` |
| `005ad1c43000-005ad1c95000` | .so | `r-xp` | 328 | 300 | 10 | 60 | 15 | 18.29% | `/system/lib64/platformsdk/libruntime.z.so` |
| `00260ae40000-00260aec0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 56 | 14 | 10.94% | `[anon:ArkTS Heap]` |
| `00260d100000-00260d140000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 56 | 14 | 21.88% | `[anon:ArkTS Heapshared old space]` |
| `00260e500000-00260e540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 56 | 14 | 21.88% | `[anon:ArkTS Heapshared old space]` |
| `00260e9c0000-00260ea40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 56 | 14 | 10.94% | `[anon:ArkTS Heap]` |
| `00260f1c0000-00260f200000` | ark ts heap | `rw-p` | 256 | 256 | 57 | 56 | 14 | 21.88% | `[anon:ArkTS Heapappspawn space]` |
| `00260fd40000-00260fd80000` | ark ts heap | `rw-p` | 256 | 256 | 124 | 56 | 14 | 21.88% | `[anon:ArkTS Heapshared appspawn space]` |
| `005a49593000-005a4962c000` | FilePage other | `r--p` | 612 | 260 | 3 | 56 | 14 | 9.15% | `/system/lib/ld-musl-aarch64.so.1` |
| `005ad2646000-005ad26ba000` | .so | `r-xp` | 464 | 152 | 13 | 56 | 14 | 12.07% | `/system/lib64/platformsdk/libmedia_foundation.z.so` |
| `005ae40f9000-005ae413d000` | .so | `r-xp` | 272 | 128 | 25 | 56 | 14 | 20.59% | `/system/lib64/platformsdk/libaudio_stream_client.z.so` |
| `005b0a58d000-005b0a5b1000` | .so | `r-xp` | 144 | 132 | 19 | 56 | 14 | 38.89% | `/system/lib64/module/libworker.z.so` |
| `005c4df1a000-005c4e61a000` | FilePage other | `rw-p` | 7168 | 436 | 436 | 56 | 14 | 0.78% | `[anon:ffrt_coroutine_stack]` |
| `00260a500000-00260a540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 52 | 13 | 20.31% | `[anon:ArkTS Heapshared old space]` |
| `00260b040000-00260b080000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 52 | 13 | 20.31% | `[anon:ArkTS Heapshared old space]` |
| `00260b6c0000-00260b740000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 52 | 13 | 10.16% | `[anon:ArkTS Heapshared old space]` |
| `00260cc80000-00260cd40000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 52 | 13 | 6.77% | `[anon:ArkTS Heapshared old space]` |
| `00260fc80000-00260fcc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 52 | 13 | 20.31% | `[anon:ArkTS Heapshared old space]` |
| `005ad6813000-005ad6849000` | .so | `r-xp` | 216 | 116 | 4 | 52 | 13 | 24.07% | `/system/lib64/platformsdk/libnative_preferences.z.so` |
| `005ae2f9d000-005ae3345000` | .so | `r--p` | 3744 | 1752 | 169 | 52 | 13 | 1.39% | `/system/lib64/platformsdk/libace_compatible.z.so` |
| `00178f600000-00178f680000` | ark ts heap | `rw-p` | 512 | 392 | 392 | 48 | 12 | 9.38% | `[anon:ArkTS Heapnon movable space]` |
| `00260cf80000-00260cfc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heapshared old space]` |
| `00260d780000-00260d7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heapshared old space]` |
| `00260dd80000-00260ddc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heapshared old space]` |
| `00260ee80000-00260eec0000` | ark ts heap | `rw-p` | 256 | 256 | 93 | 48 | 12 | 18.75% | `[anon:ArkTS Heapappspawn space]` |
| `00260ef40000-00260ef80000` | ark ts heap | `rw-p` | 256 | 256 | 57 | 48 | 12 | 18.75% | `[anon:ArkTS Heapappspawn space]` |
| `00260f9c0000-00260fa00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 48 | 12 | 18.75% | `[anon:ArkTS Heap]` |
| `005acd1c6000-005acd1d5000` | .so | `r-xp` | 60 | 48 | 0 | 48 | 12 | 80.00% | `/system/lib64/platformsdk/libzuri.z.so` |
| `005acec61000-005acecc5000` | .so | `r-xp` | 400 | 184 | 6 | 48 | 12 | 12.00% | `/system/lib64/platformsdk/libdatashare_consumer.z.so` |
| `0026097c0000-002609800000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heapshared old space]` |
| `00260ab00000-00260ab40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heap]` |
| `00260d940000-00260d980000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 44 | 11 | 17.19% | `[anon:ArkTS Heapshared old space]` |
| `00260ee00000-00260ee40000` | ark ts heap | `rw-p` | 256 | 188 | 75 | 44 | 11 | 17.19% | `[anon:ArkTS Heapappspawn space]` |
| `00260efc0000-00260f000000` | ark ts heap | `rw-p` | 256 | 256 | 84 | 44 | 11 | 17.19% | `[anon:ArkTS Heapappspawn space]` |
| `005ad38ba000-005ad38d5000` | .so | `r--p` | 108 | 84 | 2 | 44 | 11 | 40.74% | `/system/lib64/platformsdk/libark_jsruntime.so` |
| `005b004c0000-005b00537000` | .so | `r--p` | 476 | 240 | 240 | 44 | 11 | 9.24% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `00178f7c0000-00178f800000` | ark ts heap | `rw-p` | 256 | 244 | 244 | 40 | 10 | 15.62% | `[anon:ArkTS Heapnon movable space]` |
| `002608f40000-002609000000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 40 | 10 | 5.21% | `[anon:ArkTS Heap]` |
| `002609880000-0026098c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared old space]` |
| `00260a180000-00260a200000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 40 | 10 | 7.81% | `[anon:ArkTS Heap]` |
| `00260a880000-00260a8c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared old space]` |
| `00260bb40000-00260bc00000` | ark ts heap | `rw-p` | 768 | 528 | 528 | 40 | 10 | 5.21% | `[anon:ArkTS Heap]` |
| `00260c640000-00260c680000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared old space]` |
| `00260e140000-00260e180000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heap]` |
| `00260ea80000-00260eac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heap]` |
| `00260ec40000-00260ec80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 40 | 10 | 15.62% | `[anon:ArkTS Heapshared old space]` |
| `00260f300000-00260f340000` | ark ts heap | `rw-p` | 256 | 256 | 77 | 40 | 10 | 15.62% | `[anon:ArkTS Heapappspawn space]` |
...
| `005adff72000-005ae2f9d000` | .so | `r-xp` | 49324 | 22600 | 3455 | 40 | 10 | 0.08% | `/system/lib64/platformsdk/libace_compatible.z.so` |
| `005afe4a1000-005afe4cc000` | .so | `r-xp` | 172 | 72 | 5 | 40 | 10 | 23.26% | `/system/lib64/ndk/libohaudio.so` |
...
| `00178fac0000-00178fb00000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 36 | 9 | 14.06% | `[anon:ArkTS Heapnon movable space]` |
| `00178ff40000-00178ff80000` | ark ts heap | `rw-p` | 256 | 160 | 148 | 36 | 9 | 14.06% | `[anon:ArkTS Heapshared non movable space]` |
| `00260ad80000-00260adc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 36 | 9 | 14.06% | `[anon:ArkTS Heap]` |
| `00260b5c0000-00260b600000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 36 | 9 | 14.06% | `[anon:ArkTS Heap]` |
| `00260b780000-00260b7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 36 | 9 | 14.06% | `[anon:ArkTS Heapshared old space]` |
| `00260c7c0000-00260c8c0000` | ark ts heap | `rw-p` | 1024 | 1024 | 1024 | 36 | 9 | 3.52% | `[anon:ArkTS Heapshared old space]` |
| `00260d540000-00260d5c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 36 | 9 | 7.03% | `[anon:ArkTS Heapshared old space]` |
| `00260e2c0000-00260e340000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 36 | 9 | 7.03% | `[anon:ArkTS Heap]` |
| `00260e5c0000-00260e640000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 36 | 9 | 7.03% | `[anon:ArkTS Heap]` |
| `00260ee40000-00260ee80000` | ark ts heap | `rw-p` | 256 | 256 | 62 | 36 | 9 | 14.06% | `[anon:ArkTS Heapappspawn space]` |
| `00260ef80000-00260efc0000` | ark ts heap | `rw-p` | 256 | 256 | 61 | 36 | 9 | 14.06% | `[anon:ArkTS Heapappspawn space]` |
| `005a4a0c5000-005a4a0d1000` | .so | `r-xp` | 48 | 36 | 0 | 36 | 9 | 75.00% | `/system/lib64/chipset-sdk-sp/libhitrace_meter.so` |
| `005a4ac00000-005a4ac17000` | .so | `r--p` | 92 | 52 | 1 | 36 | 9 | 39.13% | `/system/lib64/chipset-sdk-sp/libutils.z.so` |
| `005acd20e000-005acd232000` | .so | `r-xp` | 144 | 68 | 2 | 36 | 9 | 25.00% | `/system/lib64/libhap_restorecon.z.so` |
| `005aded9d000-005adedc8000` | GL | `r-xp` | 172 | 100 | 28 | 36 | 9 | 20.93% | `/system/lib64/platformsdk/libaudio_renderer.z.so` |
| `005b09f90000-005b09faf000` | .so | `r-xp` | 124 | 92 | 11 | 36 | 9 | 29.03% | `/system/lib64/platformsdk/libsensor_client.z.so` |
| `005d1e482000-005d1e782000` | FilePage other | `rw-p` | 3072 | 176 | 176 | 36 | 9 | 1.17% | `[anon:ffrt_coroutine_stack]` |
| `005d1fc7a000-005d2047b000` | FilePage other | `rw-p` | 8196 | 48 | 48 | 36 | 9 | 0.44% | `[anon:stack:30256]` |
| `007f686cb000-007f68ec8000` | stack | `rw-p` | 8180 | 100 | 100 | 36 | 9 | 0.44% | `[stack]` |
| `00178ff80000-00178ffc0000` | ark ts heap | `rw-p` | 256 | 44 | 28 | 32 | 8 | 12.50% | `[anon:ArkTS Heapshared read only space]` |
| `00260b840000-00260b880000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 32 | 8 | 12.50% | `[anon:ArkTS Heapshared old space]` |
| `00260c0c0000-00260c140000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 32 | 8 | 6.25% | `[anon:ArkTS Heap]` |
| `00260c600000-00260c640000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heap]` |
| `00260cf00000-00260cf40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heap]` |
| `00260d680000-00260d6c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heap]` |
| `00260e700000-00260e740000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 32 | 8 | 12.50% | `[anon:ArkTS Heap]` |
| `005ae3f62000-005ae3f6f000` | .so | `r--p` | 52 | 40 | 15 | 32 | 8 | 61.54% | `/system/lib64/platformsdk/libav_codec_client.z.so` |
| `005af967d000-005af975e000` | FilePage other | `rw-p` | 900 | 900 | 900 | 32 | 8 | 3.56% | `[anon:ArkTS MethodLiteral]` |
| `005aff480000-005aff6b5000` | .so | `r--p` | 2260 | 1608 | 1608 | 32 | 8 | 1.42% | `/data/storage/el1/bundle/libs/arm64/librnoh.so` |
| `005b002a0000-005b00314000` | .so | `r-xp` | 464 | 332 | 332 | 32 | 8 | 6.90% | `/data/storage/el1/bundle/libs/arm64/librnoh_app.so` |
| `005b06fc8000-005b06fd4000` | .so | `r-xp` | 48 | 36 | 2 | 32 | 8 | 66.67% | `/system/lib64/libpreferences_jscommon.z.so` |
| `005c56015000-005c56400000` | AnonPage other | `rw-p` | 4012 | 2852 | 2852 | 32 | 8 | 0.80% | `(anonymous)` |
| `00178fcc0000-00178fd00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heapnon movable space]` |
| `001e60000000-001e60080000` | ark ts heap | `rw-p` | 512 | 456 | 456 | 28 | 7 | 5.47% | `[anon:ArkTS Heaphuge object space]` |
| `002608dc0000-002608e00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heapshared old space]` |
| `00260bac0000-00260bb00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260bc40000-00260bc80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heapshared old space]` |
| `00260ca80000-00260cac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heap]` |
| `00260f840000-00260f880000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 28 | 7 | 10.94% | `[anon:ArkTS Heapshared old space]` |
| `00260fdc0000-00260fe00000` | ark ts heap | `rw-p` | 256 | 256 | 69 | 28 | 7 | 10.94% | `[anon:ArkTS Heapshared appspawn space]` |
...
| `005ae3fa0000-005ae3fe8000` | .so | `r-xp` | 288 | 120 | 21 | 28 | 7 | 9.72% | `/system/lib64/platformsdk/libaudio_utils.z.so` |
| `005af8206000-005af8506000` | FilePage other | `rw-p` | 3072 | 48 | 48 | 28 | 7 | 0.91% | `[anon:ffrt_coroutine_stack]` |
| `005affab8000-005affae9000` | GL | `r-xp` | 196 | 88 | 88 | 28 | 7 | 14.29% | `/data/storage/el1/bundle/libs/arm64/libreact_render_scheduler.so` |
| `005b0070b000-005b00715000` | .so | `r--p` | 40 | 40 | 40 | 28 | 7 | 70.00% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
...
| `005c55815000-005c55c14000` | AnonPage other | `rw-p` | 4092 | 4092 | 4092 | 28 | 7 | 0.68% | `(anonymous)` |
| `00178f740000-00178f780000` | ark ts heap | `rw-p` | 256 | 232 | 232 | 24 | 6 | 9.38% | `[anon:ArkTS Heapnon movable space]` |
| `00178f900000-00178f940000` | ark ts heap | `rw-p` | 256 | 208 | 208 | 24 | 6 | 9.38% | `[anon:ArkTS Heapnon movable space]` |
| `00178fe40000-00178fe80000` | ark ts heap | `rw-p` | 256 | 240 | 240 | 24 | 6 | 9.38% | `[anon:ArkTS Heapnon movable space]` |
| `002608b80000-002608c40000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 24 | 6 | 3.12% | `[anon:ArkTS Heap]` |
| `0026092c0000-002609300000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heap]` |
| `00260acc0000-00260ad00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heapshared old space]` |
| `00260bec0000-00260bf00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heapshared old space]` |
| `00260cc40000-00260cc80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heapshared old space]` |
| `00260f280000-00260f2c0000` | ark ts heap | `rw-p` | 256 | 256 | 30 | 24 | 6 | 9.38% | `[anon:ArkTS Heapappspawn space]` |
| `00260f980000-00260f9c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 24 | 6 | 9.38% | `[anon:ArkTS Heap]` |
| `005a4abae000-005a4abb9000` | .so | `r--p` | 44 | 28 | 0 | 24 | 6 | 54.55% | `/system/lib64/chipset-sdk-sp/libc++.so` |
| `005a4adc5000-005a4adcd000` | .so | `r-xp` | 32 | 24 | 0 | 24 | 6 | 75.00% | `/system/lib64/chipset-sdk-sp/libhitracechain.so` |
| `005ace905000-005ace90d000` | Graph | `r--p` | 32 | 24 | 1 | 24 | 6 | 75.00% | `/system/lib64/chipset-sdk-sp/libsurface.z.so` |
| `005acecc5000-005acecd5000` | .so | `r--p` | 64 | 52 | 1 | 24 | 6 | 37.50% | `/system/lib64/platformsdk/libdatashare_consumer.z.so` |
...
| `00178f780000-00178f7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapnon movable space]` |
| `00178fd40000-00178fd80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapnon movable space]` |
| `00178fec0000-00178ff00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapnon movable space]` |
| `00260a940000-00260a9c0000` | ark ts heap | `rw-p` | 512 | 488 | 488 | 20 | 5 | 3.91% | `[anon:ArkTS Heap]` |
| `00260af00000-00260af40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heap]` |
| `00260de80000-00260dec0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heap]` |
| `00260e480000-00260e4c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 20 | 5 | 7.81% | `[anon:ArkTS Heapsemi space]` |
| `00260eec0000-00260ef00000` | ark ts heap | `rw-p` | 256 | 256 | 26 | 20 | 5 | 7.81% | `[anon:ArkTS Heapappspawn space]` |
| `00260f100000-00260f140000` | ark ts heap | `rw-p` | 256 | 256 | 26 | 20 | 5 | 7.81% | `[anon:ArkTS Heapappspawn space]` |
| `00260f8c0000-00260f900000` | ark ts heap | `rw-p` | 256 | 172 | 86 | 20 | 5 | 7.81% | `[anon:ArkTS Heapshared appspawn space]` |
| `005a4aa80000-005a4ab10000` | .so | `r--p` | 576 | 260 | 8 | 20 | 5 | 3.47% | `/system/lib64/chipset-sdk-sp/libc++.so` |
| `005a4ad40000-005a4ad52000` | .so | `r--p` | 72 | 20 | 0 | 20 | 5 | 27.78% | `/system/lib64/libhilog_inner.so` |
...
| `005ae33f9000-005ae34b9000` | FilePage other | `rw-p` | 768 | 316 | 286 | 20 | 5 | 2.60% | `[anon:libace_compatible.z.so.bss]` |
| `005ae3600000-005ae3638000` | .so | `r--p` | 224 | 52 | 6 | 20 | 5 | 8.93% | `/system/lib64/platformsdk/libaudio_common.z.so` |
...
| `00260a280000-00260a300000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 16 | 4 | 3.12% | `[anon:ArkTS Heap]` |
| `00260a9c0000-00260aa40000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 16 | 4 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260cfc0000-00260d000000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260e640000-00260e700000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 16 | 4 | 2.08% | `[anon:ArkTS Heapshared old space]` |
| `00260e880000-00260e900000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 16 | 4 | 3.12% | `[anon:ArkTS Heap]` |
| `00260ed40000-00260ed80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260f080000-00260f0c0000` | ark ts heap | `rw-p` | 256 | 256 | 46 | 16 | 4 | 6.25% | `[anon:ArkTS Heapappspawn space]` |
| `00260f700000-00260f740000` | ark ts heap | `rw-p` | 256 | 184 | 184 | 16 | 4 | 6.25% | `[anon:ArkTS Heap]` |
| `00260fcc0000-00260fd00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 16 | 4 | 6.25% | `[anon:ArkTS Heapshared old space]` |
| `005acc3c1000-005acc3c6000` | GL | `r--p` | 20 | 16 | 0 | 16 | 4 | 80.00% | `/system/lib64/platformsdk/libipc_single.z.so` |
| `005acce00000-005acce14000` | .so | `r--p` | 80 | 40 | 1 | 16 | 4 | 20.00% | `/system/lib64/chipset-sdk-sp/libeventhandler.z.so` |
...
| `005d1ebc0000-005d1ec46000` | .so | `r--p` | 536 | 448 | 448 | 16 | 4 | 2.99% | `/data/storage/el1/bundle/libs/arm64/libdanmu.so` |
| `005d1f34b000-005d1f358000` | Graph | `r-xp` | 52 | 52 | 15 | 16 | 4 | 30.77% | `/system/lib64/libgameservice_graphic_plugin.z.so` |
| `005d21292000-005d21393000` | FilePage other | `rw-p` | 1028 | 20 | 20 | 16 | 4 | 1.56% | `[anon:stack:30325]` |
| `005d21395000-005d21496000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 16 | 4 | 1.56% | `[anon:stack:30326]` |
| `002609380000-0026093c0000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260afc0000-00260b000000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapsemi space]` |
| `00260b3c0000-00260b440000` | ark ts heap | `rw-p` | 512 | 508 | 508 | 12 | 3 | 2.34% | `[anon:ArkTS Heapshared old space]` |
| `00260b540000-00260b580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260b8c0000-00260b980000` | ark ts heap | `rw-p` | 768 | 768 | 768 | 12 | 3 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260c180000-00260c200000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 12 | 3 | 2.34% | `[anon:ArkTS Heapshared old space]` |
| `00260c280000-00260c300000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 12 | 3 | 2.34% | `[anon:ArkTS Heapshared old space]` |
| `00260d440000-00260d480000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260d5c0000-00260d600000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heap]` |
| `00260e540000-00260e5c0000` | ark ts heap | `rw-p` | 512 | 264 | 264 | 12 | 3 | 2.34% | `[anon:ArkTS Heapsemi space]` |
| `00260e780000-00260e7c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapshared old space]` |
| `00260ecc0000-00260ed00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 12 | 3 | 4.69% | `[anon:ArkTS Heapsemi space]` |
...
| `005a497a2000-005a497aa000` | FilePage other | `r--p` | 32 | 24 | 1 | 12 | 3 | 37.50% | `/system/lib/ld-musl-aarch64.so.1` |
...
| `005a4a0d3000-005a4a0df000` | native heap | `rw-p` | 48 | 32 | 1 | 12 | 3 | 25.00% | `[anon:native_heap:brk]` |
...
| `005a4adc0000-005a4adc5000` | .so | `r--p` | 20 | 16 | 0 | 12 | 3 | 60.00% | `/system/lib64/chipset-sdk-sp/libhitracechain.so` |
...
| `005acd280000-005acd286000` | .so | `r--p` | 24 | 12 | 0 | 12 | 3 | 50.00% | `/system/lib64/platformsdk/libipc_common.z.so` |
...
| `005ada640000-005ada666000` | GL | `r--p` | 152 | 128 | 8 | 12 | 3 | 7.89% | `/system/lib64/libEGL.so` |
...
| `005b00314000-005b00323000` | .so | `r--p` | 60 | 60 | 60 | 12 | 3 | 20.00% | `/data/storage/el1/bundle/libs/arm64/librnoh_app.so` |
...
| `005c4d996000-005c4da97000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 12 | 3 | 1.17% | `[anon:stack:30061]` |
| `005d18c9f000-005d18cce000` | .so | `r-xp` | 188 | 164 | 14 | 12 | 3 | 6.38% | `/system/lib64/platformsdk/libhttp_client.z.so` |
| `005d20986000-005d20a87000` | FilePage other | `rw-p` | 1028 | 20 | 20 | 12 | 3 | 1.17% | `[anon:stack:30292]` |
| `005d20e86000-005d20f87000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 12 | 3 | 1.17% | `[anon:stack:30275]` |
...
| `002609d40000-002609d80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260ad00000-00260ad80000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260b340000-00260b3c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 8 | 2 | 1.56% | `[anon:ArkTS Heapsemi space]` |
| `00260c080000-00260c0c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapsemi space]` |
| `00260c300000-00260c340000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heap]` |
| `00260cb80000-00260cbc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260cd80000-00260cdc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapsemi space]` |
| `00260df40000-00260df80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapsemi space]` |
| `00260eac0000-00260eb00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapsemi space]` |
| `00260f040000-00260f080000` | ark ts heap | `rw-p` | 256 | 256 | 61 | 8 | 2 | 3.12% | `[anon:ArkTS Heapappspawn space]` |
| `00260f140000-00260f180000` | ark ts heap | `rw-p` | 256 | 256 | 18 | 8 | 2 | 3.12% | `[anon:ArkTS Heapappspawn space]` |
| `00260f340000-00260f380000` | ark ts heap | `rw-p` | 256 | 256 | 53 | 8 | 2 | 3.12% | `[anon:ArkTS Heapappspawn space]` |
| `00260f480000-00260f4c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared old space]` |
| `00260f640000-00260f680000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 8 | 2 | 3.12% | `[anon:ArkTS Heapsemi space]` |
| `00260fc00000-00260fc40000` | ark ts heap | `rw-p` | 256 | 84 | 84 | 8 | 2 | 3.12% | `[anon:ArkTS Heapsemi space]` |
| `00260fe40000-00260fe80000` | ark ts heap | `rw-p` | 256 | 48 | 24 | 8 | 2 | 3.12% | `[anon:ArkTS Heapshared appspawn space]` |
...
| `005a4ad83000-005a4ad86000` | .so | `r--p` | 12 | 12 | 0 | 8 | 2 | 66.67% | `/system/lib64/libhilog_inner.so` |
| `005a4aec0000-005a4aec3000` | .so | `r--p` | 12 | 8 | 0 | 8 | 2 | 66.67% | `/system/lib64/chipset-sdk-sp/libsec_shared.z.so` |
...
| `005ad65cf000-005ad65f5000` | dev | `rw-s` | 152 | 152 | 152 | 8 | 2 | 5.26% | `anon_inode:dev/ashmem/EXTRawData` |
...
| `005ad6e1a000-005ad6e40000` | dev | `rw-s` | 152 | 152 | 152 | 8 | 2 | 5.26% | `anon_inode:dev/ashmem/EXTRawData` |
...
| `005ae3345000-005ae33f9000` | .so | `rw-p` | 720 | 376 | 162 | 8 | 2 | 1.11% | `/system/lib64/platformsdk/libace_compatible.z.so` |
...
| `005affe61000-005affe68000` | .so | `r--p` | 28 | 28 | 28 | 8 | 2 | 28.57% | `/data/storage/el1/bundle/libs/arm64/librnoh_reanimated.so` |
| `005b00715000-005b00717000` | .so | `rw-p` | 8 | 8 | 8 | 8 | 2 | 100.00% | `/data/storage/el1/bundle/libs/arm64/libhermes.so` |
| `005b00717000-005b0071a000` | FilePage other | `rw-p` | 12 | 12 | 12 | 8 | 2 | 66.67% | `[anon:libhermes.so.bss]` |
...
| `005b0a040000-005b0a049000` | .so | `r--p` | 36 | 20 | 6 | 8 | 2 | 22.22% | `/system/lib64/module/libsensor.z.so` |
...
| `005d20d83000-005d20e84000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 8 | 2 | 0.78% | `[anon:stack:30274]` |
...
| `002609540000-002609580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapsemi space]` |
| `002609bc0000-002609c00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `002609c80000-002609cc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heap]` |
| `00260a300000-00260a380000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260a3c0000-00260a400000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapsemi space]` |
| `00260a700000-00260a740000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heap]` |
| `00260b000000-00260b040000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapsemi space]` |
| `00260b140000-00260b1c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260b7c0000-00260b840000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260be80000-00260bec0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapsemi space]` |
| `00260bf40000-00260bf80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260c480000-00260c500000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 4 | 1 | 0.78% | `[anon:ArkTS Heapshared old space]` |
| `00260cc00000-00260cc40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260ea40000-00260ea80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
| `00260f180000-00260f1c0000` | ark ts heap | `rw-p` | 256 | 256 | 34 | 4 | 1 | 1.56% | `[anon:ArkTS Heapappspawn space]` |
| `00260f740000-00260f780000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 4 | 1 | 1.56% | `[anon:ArkTS Heapshared old space]` |
...
| `005a49abc000-005a49abd000` | dev | `r--s` | 4 | 4 | 0 | 4 | 1 | 100.00% | `/dev/__parameters__/u:object_r:hook_param:s0` |
...
| `005a4ad98000-005a4ad99000` | dev | `r--s` | 4 | 4 | 0 | 4 | 1 | 100.00% | `/dev/__parameters__/u:object_r:ark_profile:s0` |
...
| `005a4add0000-005a4adfe000` | FilePage other | `rw-p` | 184 | 132 | 44 | 4 | 1 | 2.17% | `/system/etc/abc/framework/jsEnumStyle.abc` |
...
| `005a4ae99000-005a4aea1000` | native heap | `rw-p` | 32 | 32 | 1 | 4 | 1 | 12.50% | `[anon:native_heap:brk]` |
...
| `005acec09000-005acec10000` | .so | `r--p` | 28 | 28 | 1 | 4 | 1 | 14.29% | `/system/lib64/librosen_text.z.so` |
...
| `005ad684e000-005ad6874000` | dev | `rw-s` | 152 | 152 | 152 | 4 | 1 | 2.63% | `anon_inode:dev/ashmem/EXTRawData` |
...
| `005afec21000-005afec23000` | .so | `r--p` | 8 | 8 | 8 | 4 | 1 | 50.00% | `/system/lib64/ndk/libnative_drm.so` |
...
| `005affe1e000-005affe61000` | .so | `r-xp` | 268 | 48 | 48 | 4 | 1 | 1.49% | `/data/storage/el1/bundle/libs/arm64/librnoh_reanimated.so` |
...
| `005b02400000-005b0242d000` | .so | `r--p` | 180 | 132 | 132 | 4 | 1 | 2.22% | `/data/storage/el1/bundle/libs/arm64/libjsi.so` |
...
| `005b0a362000-005b0a365000` | .so | `r--p` | 12 | 12 | 0 | 4 | 1 | 33.33% | `/system/lib64/module/libutil.z.so` |
...
| `005d2047d000-005d2057e000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 4 | 1 | 0.39% | `[anon:stack:30277]` |
...
| `005d432ec000-005d433ed000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 4 | 1 | 0.39% | `[anon:stack:31124]` |
...
| `00178f800000-00178f840000` | ark ts heap | `rw-p` | 256 | 252 | 252 | 0 | 0 | 0.00% | `[anon:ArkTS Heapnon movable space]` |
...
| `002608e00000-002608e40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `002608e40000-002608e80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `0026091c0000-002609200000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `002609300000-002609380000` | guard | `---p` | 512 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `002609a00000-002609a80000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `002609f80000-002609fc0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260a400000-00260a440000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
| `00260a440000-00260a480000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260a480000-00260a500000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
| `00260a540000-00260a580000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260aa40000-00260aac0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
...
| `00260adc0000-00260ae00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
| `00260ae00000-00260ae40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
| `00260aec0000-00260af00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260b080000-00260b0c0000` | ark ts heap | `rw-p` | 256 | 28 | 28 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
| `00260b0c0000-00260b100000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
| `00260b100000-00260b140000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260bcc0000-00260bd00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260c040000-00260c080000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260c140000-00260c180000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
| `00260c340000-00260c3c0000` | ark ts heap | `rw-p` | 512 | 512 | 512 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260c500000-00260c540000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260c680000-00260c700000` | ark ts heap | `rw-p` | 512 | 408 | 408 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260cb00000-00260cb40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260d080000-00260d0c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260d480000-00260d4c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260d7c0000-00260d800000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260da80000-00260dac0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
| `00260dac0000-00260db00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260de40000-00260de80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260e040000-00260e080000` | guard | `---p` | 256 | 0 | 0 | 0 | 0 | 0.00% | `[anon:ArkTS Heap]` |
...
| `00260e1c0000-00260e200000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260e440000-00260e480000` | ark ts heap | `rw-p` | 256 | 96 | 96 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
| `00260e4c0000-00260e500000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260e840000-00260e880000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260ebc0000-00260ec00000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapshared old space]` |
...
| `00260f5c0000-00260f600000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
| `00260f680000-00260f6c0000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260fa40000-00260fa80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260fd00000-00260fd40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `00260ff00000-00260ff40000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
| `00260ff40000-00260ff80000` | ark ts heap | `rw-p` | 256 | 256 | 256 | 0 | 0 | 0.00% | `[anon:ArkTS Heapsemi space]` |
...
| `003800001000-003800002000` | FilePage other | `rw-p` | 4 | 4 | 4 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003800002000-003800004000` | guard | `---p` | 8 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003800004000-003800174000` | FilePage other | `rw-p` | 1472 | 468 | 468 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
...
| `003800204000-003800254000` | FilePage other | `rw-p` | 320 | 92 | 92 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003800254000-003c00001000` | guard | `---p` | 16774836 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00001000-003c00003000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00003000-003c00004000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00004000-003c001fc000` | FilePage other | `rw-p` | 2016 | 1620 | 1620 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c001fc000-003c00201000` | guard | `---p` | 20 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00201000-003c00203000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00203000-003c00204000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00204000-003c003f4000` | FilePage other | `rw-p` | 1984 | 1316 | 1316 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c003f4000-003c00401000` | guard | `---p` | 52 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00401000-003c00403000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00403000-003c00404000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00404000-003c005f8000` | FilePage other | `rw-p` | 2000 | 1084 | 1084 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c005f8000-003c00601000` | guard | `---p` | 36 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00601000-003c00603000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00603000-003c00604000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00604000-003c007c0000` | FilePage other | `rw-p` | 1776 | 1056 | 1056 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c007c0000-003c00801000` | guard | `---p` | 260 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00801000-003c00803000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00803000-003c00804000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00804000-003c009fc000` | FilePage other | `rw-p` | 2016 | 1660 | 1660 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c009fc000-003c00a01000` | guard | `---p` | 20 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00a01000-003c00a03000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00a03000-003c00a04000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00a04000-003c00bf8000` | FilePage other | `rw-p` | 2000 | 968 | 968 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00bf8000-003c00c01000` | guard | `---p` | 36 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00c01000-003c00c03000` | FilePage other | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00c03000-003c00c04000` | guard | `---p` | 4 | 0 | 0 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
| `003c00c04000-003c00cd4000` | FilePage other | `rw-p` | 832 | 188 | 188 | 0 | 0 | 0.00% | `[anon:partition_alloc]` |
...
| `005a4ae80000-005a4ae82000` | .so | `r--p` | 8 | 4 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhilog.so` |
...
| `005a4b039000-005a4b040000` | FilePage other | `rw-p` | 28 | 0 | 0 | 0 | 0 | 0.00% | `[anon:signal_stack:34714]` |
...
| `005acbe7c000-005acbee3000` | GL | `r-xp` | 412 | 352 | 17 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libglobal_resmgr.z.so` |
...
| `005acd14c000-005acd15d000` | .so | `r-xp` | 68 | 48 | 2 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libextractortool.z.so` |
...
| `005acf05a000-005acf076000` | .so | `r-xp` | 112 | 100 | 12 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libwantagent_innerkits.z.so` |
...
| `005ad5783000-005ad5788000` | GL | `r-xp` | 20 | 12 | 0 | 0 | 0 | 0.00% | `/system/lib64/libarkweb_glue_base.z.so` |
| `005ad5788000-005ad5789000` | GL | `r--p` | 4 | 4 | 1 | 0 | 0 | 0.00% | `/system/lib64/libarkweb_glue_base.z.so` |
| `005ad5789000-005ad578a000` | GL | `rw-p` | 4 | 4 | 4 | 0 | 0 | 0.00% | `/system/lib64/libarkweb_glue_base.z.so` |
...
| `005ad6bed000-005ad6d41000` | .so | `r-xp` | 1360 | 884 | 21 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libsqlite.z.so` |
...
| `005ad7500000-005ad765b000` | .so | `r--p` | 1388 | 612 | 25 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libcrypto_openssl.z.so` |
| `005ad765b000-005ad782d000` | .so | `r-xp` | 1864 | 1084 | 41 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk-sp/libcrypto_openssl.z.so` |
...
| `005ad7fc0000-005ad7fd3000` | .so | `r--p` | 76 | 24 | 1 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libsession_manager_lite.z.so` |
| `005ad7fd3000-005ad7ff6000` | .so | `r-xp` | 140 | 108 | 11 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libsession_manager_lite.z.so` |
...
| `005ad9f40000-005ad9f92000` | .so | `r--p` | 328 | 132 | 7 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnative_rdb.z.so` |
| `005ad9f92000-005ada092000` | .so | `r-xp` | 1024 | 752 | 22 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnative_rdb.z.so` |
...
| `005add7c0000-005add814000` | .so | `r--p` | 336 | 192 | 22 | 0 | 0 | 0.00% | `/system/lib64/libaudio_framework_interface.z.so` |
...
| `005adda80000-005addaab000` | .so | `r--p` | 172 | 120 | 36 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_client.z.so` |
...
| `005adf5c0000-005adff72000` | .so | `r--p` | 9928 | 1976 | 189 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libace_compatible.z.so` |
...
| `005ae466e000-005ae46bc000` | .so | `r-xp` | 312 | 312 | 49 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libaudio_policy_client.z.so` |
...
| `005ae5f60000-005ae7a38000` | GL | `r-xp` | 27488 | 608 | 113 | 0 | 0 | 0.00% | `/vendor/lib64/passthrough/indirect/libbishenggpucompiler_v210.so.15` |
...
| `005aecd00000-005aecd9d000` | .so | `r--p` | 628 | 216 | 22 | 0 | 0 | 0.00% | `/system/lib64/libans_innerkits.z.so` |
...
| `005aed100000-005aed132000` | .so | `r--p` | 200 | 120 | 8 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libssl_openssl.z.so` |
...
| `005aee2c4000-005aee2c8000` | .so | `r-xp` | 16 | 16 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhdc_register.z.so` |
| `005aee2c8000-005aee2c9000` | .so | `r--p` | 4 | 4 | 0 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libhdc_register.z.so` |
...
| `005af1728000-005af1829000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 0 | 0 | 0.00% | `[anon:stack:30002]` |
...
| `005af192e000-005af1a2f000` | FilePage other | `rw-p` | 1028 | 16 | 16 | 0 | 0 | 0.00% | `[anon:stack:30004]` |
...
| `005af8000000-005af8002000` | guard | `---p` | 8 | 0 | 0 | 0 | 0 | 0.00% | `[anon:guard:34714]` |
| `005af8002000-005af8103000` | FilePage other | `rw-p` | 1028 | 8 | 8 | 0 | 0 | 0.00% | `[anon:stack:34714]` |
...
| `005af91d6000-005af92d7000` | FilePage other | `rw-p` | 1028 | 12 | 12 | 0 | 0 | 0.00% | `[anon:stack:30020]` |
...
| `005afa478000-005afa59d000` | .so | `r-xp` | 1172 | 964 | 45 | 0 | 0 | 0.00% | `/system/lib64/module/file/libfs.z.so` |
...
| `005afb65e000-005afb6c6000` | .so | `r-xp` | 416 | 348 | 51 | 0 | 0 | 0.00% | `/system/lib64/module/net/libhttp.z.so` |
| `005afb6c6000-005afb6ca000` | .so | `r--p` | 16 | 16 | 16 | 0 | 0 | 0.00% | `/system/lib64/module/net/libhttp.z.so` |
| `005afb6ca000-005afb6cb000` | .so | `rw-p` | 4 | 4 | 4 | 0 | 0 | 0.00% | `/system/lib64/module/net/libhttp.z.so` |
...
| `005afeae1000-005afebb1000` | .so | `r-xp` | 832 | 224 | 14 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnweb_ohos_adapter.z.so` |
| `005afebb1000-005afebc1000` | .so | `r--p` | 64 | 64 | 64 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libnweb_ohos_adapter.z.so` |
...
| `005b07680000-005b0769c000` | .so | `r--p` | 112 | 16 | 2 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libopenhitls_tls.z.so` |
...
| `005b078b6000-005b07955000` | .so | `r-xp` | 636 | 492 | 27 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libcurl_shared_http3.z.so` |
...
| `005b082c0000-005b08303000` | .so | `r--p` | 268 | 68 | 3 | 0 | 0 | 0.00% | `/system/lib64/platformsdk/libtel_core_service_api.z.so` |
...
| `005b085c0000-005b085e5000` | .so | `r--p` | 148 | 76 | 10 | 0 | 0 | 0.00% | `/system/lib64/chipset-sdk/libcurl_shared.z.so` |
...
| `005c4d63a000-005c4d73b000` | FilePage other | `rw-p` | 1028 | 44 | 44 | 0 | 0 | 0.00% | `[anon:stack:30058]` |
...
| `005c4f74e000-005c4f84f000` | FilePage other | `rw-p` | 1028 | 20 | 20 | 0 | 0 | 0.00% | `[anon:stack:30068]` |
...
| `005d2d240000-005d2e18a000` | .so | `r--p` | 15656 | 7200 | 2079 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005d2e18a000-005d37761000` | .so | `r-xp` | 153436 | 27324 | 11179 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005d37761000-005d37fdc000` | .so | `r--p` | 8684 | 8668 | 8668 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005d37fdc000-005d37fe0000` | .so | `r--p` | 16 | 0 | 0 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005d37fe0000-005d380d1000` | .so | `rw-p` | 964 | 580 | 580 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libarkweb_engine.so` |
| `005d380d1000-005d3824e000` | FilePage other | `rw-p` | 1524 | 360 | 360 | 0 | 0 | 0.00% | `[anon:libarkweb_engine.so.bss]` |
...
| `005d383cc000-005d38577000` | .so | `r-xp` | 1708 | 64 | 16 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libffmpeg.so` |
| `005d38577000-005d3859f000` | .so | `r--p` | 160 | 160 | 160 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libffmpeg.so` |
| `005d3859f000-005d385a0000` | .so | `rw-p` | 4 | 4 | 4 | 0 | 0 | 0.00% | `/data/storage/el1/bundle/arkwebcore/libs/arm64/libffmpeg.so` |
| `005d385a0000-005d3867f000` | FilePage other | `rw-p` | 892 | 8 | 8 | 0 | 0 | 0.00% | `[anon:libffmpeg.so.bss]` |
...
| `005d38afe000-005d38bdb000` | GL | `r-xp` | 884 | 240 | 23 | 0 | 0 | 0.00% | `/system/lib64/libohos_adapter_glue_source.z.so` |
| `005d38bdb000-005d38bef000` | GL | `r--p` | 80 | 80 | 80 | 0 | 0 | 0.00% | `/system/lib64/libohos_adapter_glue_source.z.so` |
| `005d38bef000-005d38bf1000` | GL | `rw-p` | 8 | 8 | 8 | 0 | 0 | 0.00% | `/system/lib64/libohos_adapter_glue_source.z.so` |
...
| `005d3a9e3000-005d3abe4000` | FilePage other | `rw-p` | 2052 | 8 | 8 | 0 | 0 | 0.00% | `[anon:stack:30360]` |
...
| `005d431ea000-005d432ea000` | FilePage other | `rw-p` | 1024 | 16 | 16 | 0 | 0 | 0.00% | `[anon:ffrt_coroutine_stack]` |
...
| `005d4498c000-005d44b8c000` | FilePage other | `rw-p` | 2048 | 92 | 92 | 0 | 0 | 0.00% | `[anon:ffrt_coroutine_stack]` |
