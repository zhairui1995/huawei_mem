#!/usr/bin/env python3
"""Train and evaluate the in-app operation SCNN experiment group."""
...
def evaluate(model: OpScnnModel, test_samples: list[dict], top_k: list[int]) -> list[dict]:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train in-app operation SCNN experiment group.")
    ...
    parser.add_argument("--output", default="outputs/results/op_scnn_results.csv")
...
def main() -> None:
    ...
    model = OpScnnModel(op_vocab=op_vocab, epochs=args.epochs, learning_rate=args.learning_rate)
